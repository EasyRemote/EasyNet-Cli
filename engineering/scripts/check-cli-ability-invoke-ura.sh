...
INVOKE_RS="src/cli/invoke.rs"
GROUP_RS="src/cli/groups/ability.rs"
CONTROL_SMOKE="engineering/scripts/control-smoke.sh"
CHAT_SMOKE="engineering/scripts/chat-as-ability-smoke.sh"
