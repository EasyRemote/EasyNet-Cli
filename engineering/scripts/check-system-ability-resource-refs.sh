...
manifests=(
    "ability-descriptors/system/fs.read.ability.toml"
    "ability-descriptors/system/fs.write.ability.toml"
    "ability-descriptors/system/fs.list.ability.toml"
    "ability-descriptors/system/fs.stat.ability.toml"
    "ability-descriptors/system/fs.edit.ability.toml"
    "ability-descriptors/system/fs.transfer.ability.toml"
    "ability-descriptors/system/ability.deploy.ability.toml"
)
