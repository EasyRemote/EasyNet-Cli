...
SCRIPT="$REPO_ROOT/engineering/scripts/check-release-package-contract.sh"
...
make_sandbox() {
    ...
    cp "$REPO_ROOT/engineering/scripts/build-release-tarball.sh" "$sandbox/scripts/build-release-tarball.sh"
    cp "$REPO_ROOT/engineering/scripts/e2e-release-install.sh" "$sandbox/scripts/e2e-release-install.sh"
