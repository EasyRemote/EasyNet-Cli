...
SCRIPT="$REPO_ROOT/engineering/scripts/check-dispatch-mission-context-boundary.sh"
...
cp "$SCRIPT" "$SB/engineering/scripts/check-dispatch-mission-context-boundary.sh"
...
(
  cd "$SB"
  bash engineering/scripts/check-dispatch-mission-context-boundary.sh
