...
DEV1_ABILITY_PUBLISH="easynet:///r/${REALM}/ability/system-agent.${DEV1_NODE}.ability-management.ability.publish"
DEV1_ABILITY_UNPUBLISH="easynet:///r/${REALM}/ability/system-agent.${DEV1_NODE}.ability-management.ability.unpublish"
DEV1_SKILL_PUBLISH="easynet:///r/${REALM}/ability/system-agent.${DEV1_NODE}.skill-management.skill.publish"
DEV1_SKILL_UNPUBLISH="easynet:///r/${REALM}/ability/system-agent.${DEV1_NODE}.skill-management.skill.unpublish"
