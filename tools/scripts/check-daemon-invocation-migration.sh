...
for path in sorted((root / "src").rglob("*.rs")):
    ...
    for token in (
        ...
        "invoke_local_target_explicit_root_timeout",
        "invoke_local_target_stream_explicit_root",
        "invoke_local_target_bidi_json_frames_explicit_root",
...
for token, detail in (
    ...
    ("invoke_local_target_explicit_causal_timeout", "public local unary explicit causal tuple helper"),
    ("invoke_local_target_stream_explicit_causal", "public local stream explicit causal tuple helper"),
    ("invoke_local_target_bidi_json_frames_explicit_causal", "public local bidi explicit causal tuple helper"),
