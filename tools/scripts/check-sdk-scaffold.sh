...
for path in \
  ...
  tools/scripts/check-sdk-receipt-ura-boundary.sh \
...
bash "$ROOT/tools/scripts/check-sdk-receipt-ura-boundary.sh" --self-test >/dev/null
...
reject_literal sdk/go/admin_runtime.go "agentUra"
reject_literal sdk/go/admin_runtime.go "ownerUra"
reject_literal sdk/go/admin_runtime.go "deviceUra"
reject_literal sdk/go/admin_runtime.go "hubUra"
reject_literal sdk/go/admin_runtime.go "sessionId"
reject_literal sdk/go/admin_runtime.go "sessionKind"
reject_literal sdk/go/admin_runtime.go "expiresUnixMs"
reject_literal sdk/go/admin_runtime.go "createdUnixMs"
reject_literal sdk/go/admin_runtime.go "tokenId"
reject_literal sdk/go/admin_runtime.go "credentialId"
reject_literal sdk/go/admin_runtime.go "pairingToken"
reject_literal sdk/go/admin_runtime.go "verificationMethod"
reject_literal sdk/go/admin_runtime.go "nextCursor"
...
reject_literal sdk/go/compatibility.go "RetrieveFile"
...
reject_literal sdk/python/easynet_sdk/profile_bridge.py "agentUra"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "ownerUra"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "deviceUra"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "hubUra"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "sessionId"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "sessionKind"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "expiresUnixMs"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "createdUnixMs"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "tokenId"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "credentialId"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "pairingToken"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "verificationMethod"
reject_literal sdk/python/easynet_sdk/profile_bridge.py "nextCursor"
