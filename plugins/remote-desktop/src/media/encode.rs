...
#[derive(Debug, Clone)]
pub(in crate::daemon::plugins::remote_desktop) struct BuiltinH264Config {
    pub(in crate::daemon::plugins::remote_desktop) backend: RemoteDesktopMediaBackendDescriptor,
...
pub(in crate::daemon::plugins::remote_desktop) enum BuiltinH264StreamTerminal {
    Closed(&'static str),
    Failed {
        reason: &'static str,
        message: String,
...
pub(in crate::daemon::plugins::remote_desktop) type BuiltinH264TerminalCallback =
...
pub(in crate::daemon::plugins::remote_desktop) fn build_openh264_encoder(
    config: &BuiltinH264Config,
