...
```powershell
dotnet build .\plugins\desktop-menubar\companion\windows\EasyNetTray\EasyNetTray.csproj -c Release
```

Run:

```powershell
.\plugins\desktop-menubar\companion\windows\EasyNetTray\bin\Release\net8.0-windows\EasyNetTray.exe
```
