...
#   include/easynet_cli.h                — libeasynet_cli generic C ABI v6 header
#   include/easynet_cli.exports.v6       — exact 55-symbol export allowlist
#   docs/spec/ffi-abi-v6.md              — binding-facing ABI spec
#
...
abi_exports="$cli_root/include/easynet_cli.exports.v6"
abi_spec="$cli_root/docs/spec/ffi-abi-v6.md"
...
cp "$abi_exports" "$stage_dir/include/easynet_cli.exports.v6"
cp "$abi_spec" "$stage_dir/docs/spec/ffi-abi-v6.md"
...
echo "  path:    $out_file"
echo "  shape:   easynet, easynet-daemon, easynet-keyring, libaxon_dendrite_bridge.${lib_ext}, include/easynet_cli.h, include/easynet_cli.exports.v6, docs/spec/ffi-abi-v6.md"
