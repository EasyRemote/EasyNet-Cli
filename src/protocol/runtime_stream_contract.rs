// EasyNet CLI — Runtime stream/bidi shared contract
// =================================================
//
// File: src/protocol/runtime_stream_contract.rs
// Description: Shared Runtime Core stream/bidi DTO projections used by
//              language bindings and daemon SDK adapters.
//
