...
// =====================================================
//
// File: src/services/invocation_transport/runtime_trust_invalidator.rs
...
mod tests {
    ...
    fn removed_local_user_revoke_records_disconnected_removed_snapshot() {
        ...
        let presence = Arc::new(PresenceRegistry::new());
        let advertised = Arc::new(AdvertisedAgentStore::new());
        let subject = crate::ura::user_ura("local", "user-alice");
        presence.insert_negotiated_with_trust(
            subject.clone(),
            sender(),
            crate::services::presence_registry::SessionContract::legacy(),
        ...
        assert_eq!(
            snapshot.device_ura,
            crate::ura::device_ura("local", "dev-1")
        );
    ...
    fn removed_non_local_user_revoke_does_not_record_connection_state() {
        ...
        let presence = Arc::new(PresenceRegistry::new());
        let advertised = Arc::new(AdvertisedAgentStore::new());
        let subject = crate::ura::user_ura("local", "user-bob");
        presence.insert_negotiated_with_trust(
            subject.clone(),
            sender(),
            crate::services::presence_registry::SessionContract::legacy(),
