...
// ============================================
//
// File: src/services/invocation_transport/runtime_trust.rs
...
// delegated to `crate::ura`; Invocation admission, receipts, signatures,
    ...
    fn concurrent_registers_do_not_drop_trust_rows() {
        ...
        for index in 1..=8u8 {
            ...
            handles.push(std::thread::spawn(move || {
                ctx.writer()
                    .register_pubkey(
                        crate::ura::user_ura("realm", &format!("user-{index}")),
                        b64_pubkey(index),
                        TrustedAgentRole::User,
                    )
