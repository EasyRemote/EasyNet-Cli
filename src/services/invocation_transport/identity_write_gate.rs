...
// ======================================================
//
// File: src/services/invocation_transport/identity_write_gate.rs
...
use crate::services::invocation_transport::register_device_pubkey::RegisterPubkeyIntent;
use crate::services::invocation_transport::revoke_user_pubkey::RevokeUserPubkeyIntent;
...
impl IdentityWriteGate {
    ...
    fn is_local_backend_or_hub(&self, caller_ura: &str, caller_role: TrustedAgentRole) -> bool {
        ...
        crate::ura::hub_ura(&self.daemon_realm) == caller_ura
    }
...
mod tests {
    ...
    fn loopback_can_bootstrap_backend_row_without_anchor_entry() {
        ...
        gate.authorize_register_pubkey(
            Some(&env),
            &intent(&crate::ura::hub_ura("local"), TrustedAgentRole::Backend),
        )
    ...
    fn local_backend_can_register_device_and_user_rows() {
        let backend_ura = crate::ura::hub_ura("local");
    ...
    fn backend_can_refresh_only_its_own_backend_row() {
        ...
        let err = gate
            .authorize_register_pubkey(
                Some(&env),
                &intent(&crate::ura::hub_ura("peer"), TrustedAgentRole::Backend),
            )
    ...
    fn public_caller_cannot_register_hub_row() {
        ...
        let err = gate
            .authorize_register_pubkey(
                Some(&env),
                &intent(&crate::ura::hub_ura("peer"), TrustedAgentRole::Hub),
            )
