...
use crate::daemon::invocation::invocation_wire::SIGNED_DESCRIPTOR_REF_METADATA_KEY;
...
impl AdmissionFacade {
    ...
    pub fn with_trust_anchor_cell(
        ...
        let self_realm = daemon_ura
            .as_deref()
            .and_then(crate::daemon::invocation::register_device_pubkey::parse_realm_from_ura);
        Self {
            trust_anchor,
            daemon_ura,
    ...
    fn verify_provisional_federation_join(
        ...
        let request: crate::daemon::invocation::federation_wrappers::JoinRequest =
...
fn parse_realm_from_ura(ura: &str) -> Option<String> {
    crate::daemon::invocation::register_device_pubkey::parse_realm_from_ura(ura)
}
...
// `daemon::invocation::federated_key_resolver`.
