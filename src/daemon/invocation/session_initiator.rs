...
pub(crate) struct SessionSupervisorRunConfig<D: SessionFrameDispatcher> {
    ...
    pub(crate) escalation_outbox:
        Option<crate::daemon::invocation::session_escalation::SharedSessionOutbox>,
...
pub async fn dial_and_run_session<D: SessionFrameDispatcher>(
    ...
    dispatcher: Arc<D>,
    escalation_outbox: Option<&crate::daemon::invocation::session_escalation::SharedSessionOutbox>,
