...
//
// Why this lives in `support/` and not `cli/`
// ---------------------------------------------------
...
mod tests {
    ...
    fn device_origin_claim_round_trips_executing_device_rebuild() {
        ...
        let origin =
            crate::daemon::invocation::origin_caller::OriginCaller::from_claim(claim.clone())
        ...
        tampered[0] ^= 1;
        let origin2 = crate::daemon::invocation::origin_caller::OriginCaller::from_claim(claim)
            .expect("claim decodes");
        let wire2 = origin2
