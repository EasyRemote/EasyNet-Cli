...
// ==============================================
//
// File: src/daemon/resources/remote_desktop/runtime.rs
...
use crate::daemon::resources::remote_desktop::config::RemoteDesktopRuntimeConfig;
...
#[derive(Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopPlugin {
...
impl RemoteDesktopPlugin {
    ...
    pub(in crate::daemon::resources::remote_desktop) const fn config(
        &self,
    ) -> RemoteDesktopRuntimeConfig {
        self.config
    }

    pub(in crate::daemon::resources::remote_desktop) fn session_store(
        &self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn transport_manager(
        &self,
    ) -> Arc<RemoteDesktopTransportManager> {
        Arc::clone(&self.transports)
    }

    pub(in crate::daemon::resources::remote_desktop) fn screen_backend(
        &self,
