...
// =================================================
//
// File: src/daemon/resources/remote_desktop/permissions.rs
...
use crate::daemon::resources::remote_desktop::constants::REASON_INVALID_ARGUMENT;
use crate::daemon::resources::remote_desktop::input::{
    input_injection_available, request_input_injection_permission,
};

pub(in crate::daemon::resources::remote_desktop) fn ensure_permission_probe_access(
    ability: &str,
    env: &EnvelopeContext,
    args: &Value,
) -> anyhow::Result<()> {
...
pub(in crate::daemon::resources::remote_desktop) fn screen_capture_permission_status() -> Value {
...
pub(in crate::daemon::resources::remote_desktop) fn request_screen_capture_permission() -> Value {
...
fn platform_screen_capture_permission_granted() -> bool {
    crate::daemon::resources::remote_desktop::screencapturekit_capture::screen_capture_permission_granted()
}
...
fn platform_request_screen_capture_permission() -> bool {
    crate::daemon::resources::remote_desktop::screencapturekit_capture::request_screen_capture_permission()
}
