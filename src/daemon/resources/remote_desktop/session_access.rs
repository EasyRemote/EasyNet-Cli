...
// ==================================================
//
// File: src/daemon/resources/remote_desktop/session_access.rs
...
use crate::daemon::resources::remote_desktop::session_consent::causal_context_contains_receipt;
...
/// by `create_session`.
pub(in crate::daemon::resources::remote_desktop) fn ensure_session_control_identity(
    ability: &'static str,
    env: &EnvelopeContext,
    args: &Value,
...
pub(in crate::daemon::resources::remote_desktop) fn ensure_session_resource_identity(
    ability: &'static str,
    env: &EnvelopeContext,
    args: &Value,
    session: &RemoteDesktopSession,
