...
// ===================================================
//
// File: src/daemon/resources/remote_desktop/session_state.rs
...
pub(in crate::daemon::resources::remote_desktop) type RemoteDesktopState =
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopSessionStateMachine {
...
impl RemoteDesktopSessionStateMachine {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn mark_closed(&mut self, reason: &str) {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn expire(&mut self, reason: &str) -> bool {
        if self.is_terminal() {
            return false;
        }
    ...
    pub(in crate::daemon::resources::remote_desktop) fn fail(&mut self, reason: &str) -> bool {
        if self.is_terminal() {
            return false;
        }
