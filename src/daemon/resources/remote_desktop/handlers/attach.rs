...
use crate::daemon::resources::remote_desktop::invoke_bidi::{
...
use crate::daemon::resources::remote_desktop::session_lifecycle::ensure_session_access;
...
mod tests {
    ...
    use crate::daemon::resources::remote_desktop::runtime::RemoteDesktopPlugin;
    use crate::daemon::resources::remote_desktop::session::RemoteDesktopState;
    ...
    fn registry_with_screen_backend(backend: Arc<dyn ScreenSnapshotBackend>) -> AxonAbilityCatalog {
        ...
        crate::daemon::resources::remote_desktop::registration::contribute_with_screen_backend(
            &mut builder,
            backend,
            limits,
        )
    ...
    fn attach_bidi_client_close_detaches_preview_transport_state() {
        ...
        tokio::runtime::Runtime::new().unwrap().block_on(async {
            ...
            resources::save(&file).unwrap();
            let created =
                crate::daemon::resources::remote_desktop::handlers::create_session::handle(
                    Arc::clone(&plugin),
                    env_for(&ura),
                    json!({
