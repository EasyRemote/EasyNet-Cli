...
use crate::daemon::resources::remote_desktop::request::require_str;
use crate::daemon::resources::remote_desktop::runtime::RemoteDesktopPlugin;
use crate::daemon::resources::remote_desktop::session_lifecycle::ensure_session_control_access;
use crate::daemon::resources::remote_desktop::transport::{
    negotiate_remote_offer, RemoteOfferNegotiation,
};
use crate::daemon::resources::remote_desktop::view::serialize_session;

/// Handle `remote_desktop.set_description`.
pub(in crate::daemon::resources::remote_desktop) fn handle(
...
mod tests {
    ...
    use crate::daemon::resources::remote_desktop::test_support::seed_window;
    ...
    fn signaling_accepts_caller_subject_with_session_token() {
        ...
        let ice = crate::daemon::resources::remote_desktop::handlers::add_ice_candidate::handle(
            Arc::clone(&plugin),
            env_for("easynet:///r/acme/user/dev"),
            json!({
                "session_id": "rd-caller-subject-test",
    ...
    fn bad_remote_offer_does_not_commit_partial_session_state() {
        ...
        let shown = crate::daemon::resources::remote_desktop::handlers::show_session::handle(
            Arc::clone(&plugin),
            env_for(&ura),
