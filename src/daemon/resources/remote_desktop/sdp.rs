...
// ===================================================
//
// File: src/daemon/resources/remote_desktop/sdp.rs
...
pub(in crate::daemon::resources::remote_desktop) fn ensure_sdp_end_of_candidates(
    sdp: &str,
) -> String {
...
pub(in crate::daemon::resources::remote_desktop) fn normalize_browser_answer_sdp(
    sdp: &str,
) -> String {
...
pub(in crate::daemon::resources::remote_desktop) fn normalize_remote_offer_sdp(
    sdp: &str,
) -> String {
...
pub(in crate::daemon::resources::remote_desktop) fn remote_ice_candidate_inits(
    candidate: &Value,
