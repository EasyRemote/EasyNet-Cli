...
// ==========================================
//
// File: src/daemon/resources/remote_desktop/test_support.rs
...
use crate::daemon::resources::remote_desktop::constants::DEFAULT_FRAME_QUEUE_DEPTH;
use crate::daemon::resources::remote_desktop::runtime::RemoteDesktopPlugin;
use crate::daemon::resources::remote_desktop::session_lifecycle::stop_session_transports;

static REMOTE_DESKTOP_TEST_LOCK: Mutex<()> = Mutex::new(());

pub(in crate::daemon::resources::remote_desktop) fn test_lock() -> MutexGuard<'static, ()> {
    REMOTE_DESKTOP_TEST_LOCK
        .lock()
        .unwrap_or_else(|poisoned| poisoned.into_inner())
}

pub(in crate::daemon::resources::remote_desktop) fn test_plugin() -> Arc<RemoteDesktopPlugin> {
...
pub(in crate::daemon::resources::remote_desktop) fn test_runtime_limits() -> PluginRuntimeLimits {
    PluginRuntimeLimits::new(128, DEFAULT_FRAME_QUEUE_DEPTH as usize)
}

pub(in crate::daemon::resources::remote_desktop) fn reset_store(plugin: &RemoteDesktopPlugin) {
...
pub(in crate::daemon::resources::remote_desktop) fn env_for(subject: &str) -> EnvelopeContext {
    env_for_caller(subject, "easynet:///r/acme/user/test-caller")
}

pub(in crate::daemon::resources::remote_desktop) fn env_for_caller(
    subject: &str,
    caller: &str,
) -> EnvelopeContext {
...
pub(in crate::daemon::resources::remote_desktop) fn env_for_caller_with_causal(
    subject: &str,
    caller: &str,
...
pub(in crate::daemon::resources::remote_desktop) fn test_consent_causal_context() -> CausalContext {
...
pub(in crate::daemon::resources::remote_desktop) fn seed_display(
...
pub(in crate::daemon::resources::remote_desktop) fn seed_xcap_display(
    file: &mut ResourcesFile,
    hardware_id: &str,
) -> String {
    upsert_resource(
...
pub(in crate::daemon::resources::remote_desktop) fn seed_window(
    file: &mut ResourcesFile,
    hardware_id: &str,
) -> String {
    upsert_resource(
