...
// =================================================
//
// File: src/daemon/resources/remote_desktop/registration.rs
...
use crate::daemon::resources::remote_desktop::handlers;
use crate::daemon::resources::remote_desktop::runtime::RemoteDesktopPlugin;
use crate::daemon::resources::remote_desktop::schema;
...
pub(in crate::daemon::resources::remote_desktop) fn contribute_with_screen_backend(
    builder: &mut PluginContributionBuilder,
...
mod tests {
    ...
    fn registration_publishes_remote_desktop_manifest_to_catalog_snapshot() {
        let limits = crate::daemon::resources::remote_desktop::test_support::test_runtime_limits();
