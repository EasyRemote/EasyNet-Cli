...
// =================================================
//
// File: src/daemon/resources/remote_desktop/invoke_bidi.rs
...
use crate::daemon::resources::remote_desktop::input::{
    apply_input_frame_with_policy, input_policy_allows, input_policy_for_entry, parse_input_frame,
};
use crate::daemon::resources::remote_desktop::media::encode::{
    spawn_builtin_h264_stream, BuiltinH264StreamTerminal, BuiltinH264TerminalCallback,
};
use crate::daemon::resources::remote_desktop::request::AttachEncoding;
use crate::daemon::resources::remote_desktop::session_store::RemoteDesktopSessionStore;
use crate::daemon::resources::remote_desktop::transport::BidiTerminalGuard;

pub(in crate::daemon::resources::remote_desktop) struct BidiCaptureWorkerConfig {
    pub(in crate::daemon::resources::remote_desktop) session_store: Arc<RemoteDesktopSessionStore>,
    pub(in crate::daemon::resources::remote_desktop) session_id: String,
    pub(in crate::daemon::resources::remote_desktop) backend: Arc<dyn ScreenSnapshotBackend>,
    pub(in crate::daemon::resources::remote_desktop) entry: ResourceEntry,
    pub(in crate::daemon::resources::remote_desktop) options: ScreenCaptureOptions,
    pub(in crate::daemon::resources::remote_desktop) encoding: AttachEncoding,
    pub(in crate::daemon::resources::remote_desktop) input_policy: Value,
    pub(in crate::daemon::resources::remote_desktop) from_client: mpsc::Receiver<Value>,
    pub(in crate::daemon::resources::remote_desktop) to_client: mpsc::Sender<BidiOutputFrame>,
    pub(in crate::daemon::resources::remote_desktop) stop_tx: watch::Sender<bool>,
    pub(in crate::daemon::resources::remote_desktop) stop_rx: watch::Receiver<bool>,
    pub(in crate::daemon::resources::remote_desktop) max_frame_queue_depth: usize,
}

pub(in crate::daemon::resources::remote_desktop) fn spawn_bidi_capture_worker(
...
pub(in crate::daemon::resources::remote_desktop) fn handle_bidi_input_frame(
    input_policy: &Value,
    frame: Value,
) -> Value {
                ...
                "ping" => {
                    let _ = to_client
                        .send(BidiOutputFrame::json(json!({
                            "type": "pong",
                            "at_ms": crate::daemon::resources::remote_desktop::session::now_ms(),
                        })))
                        .await;
                }
...
fn install_h264_preview_session_for_test(
    ...
    session_store.with_sessions(|sessions| {
        let mut session = crate::daemon::resources::remote_desktop::session::RemoteDesktopSession::new(
            crate::daemon::resources::remote_desktop::session::RemoteDesktopSessionInit {
                session_id: session_id.to_string(),
                session_token: "token".to_string(),
                creator_caller_ura: Some("easynet:///r/acme/user/test-caller".to_string()),
                consent: crate::daemon::resources::remote_desktop::session_consent::RemoteDesktopConsentGrant::from_envelope_for_test(
                ...
                video:
                    crate::daemon::resources::remote_desktop::request::RemoteDesktopVideoConstraints::default(
                    ),
                input_policy:
                    crate::daemon::resources::remote_desktop::request::RemoteDesktopInputPolicy::default(),
            },
        );
