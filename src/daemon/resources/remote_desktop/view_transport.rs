...
// ======================================================
//
// File: src/daemon/resources/remote_desktop/view_transport.rs
...
use crate::daemon::resources::remote_desktop::input::INPUT_DATA_CHANNEL_LABEL;
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopTransportView {
    endpoint_ura: Value,
...
impl RemoteDesktopTransportView {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn from_session(
    ...
    pub(in crate::daemon::resources::remote_desktop) fn summary(
        &self,
        session: &RemoteDesktopSession,
    ) -> Value {
        json!({
    ...
    pub(in crate::daemon::resources::remote_desktop) fn transport_list(
        &self,
        session: &RemoteDesktopSession,
    ) -> Value {
        json!([
