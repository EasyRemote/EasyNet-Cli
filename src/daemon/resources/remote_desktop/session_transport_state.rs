...
// =============================================
//
// File: src/daemon/resources/remote_desktop/session_transport_state.rs
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopMediaStats {
    value: Value,
}
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopTransportState {
...
impl RemoteDesktopTransportState {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn mark_media_pending(&mut self) {
        self.media_transport_ready = false;
    }

    pub(in crate::daemon::resources::remote_desktop) fn mark_media_ready(&mut self) -> bool {
