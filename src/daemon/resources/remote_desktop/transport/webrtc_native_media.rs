...
// ==============================================
//
// File: src/daemon/resources/remote_desktop/transport/webrtc_native_media.rs
...
use crate::daemon::resources::remote_desktop::media::native::{
...
use crate::daemon::resources::remote_desktop::screencapturekit_capture::{
    target_for_entry, CapturedFrame, ScreenCaptureKitStream,
};
use crate::daemon::resources::remote_desktop::session::now_ms;
use crate::daemon::resources::remote_desktop::session_store::RemoteDesktopSessionStore;
use crate::daemon::resources::remote_desktop::videotoolbox_encoder::VideoToolboxEncoder;
...
pub(in crate::daemon::resources::remote_desktop) struct NativeMediaInputs<'a> {
...
pub(in crate::daemon::resources::remote_desktop) async fn run_direct_webrtc_native_stream(
    ...
    let encoder_notify = StdArc::new(move || encoder_wakeup_for_callback.notify_one())
        as crate::daemon::resources::remote_desktop::videotoolbox_encoder::EncoderWakeup;
    ...
    let sink: crate::daemon::resources::remote_desktop::screencapturekit_capture::FrameSink =
