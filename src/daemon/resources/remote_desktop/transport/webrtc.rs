...
// =================================================
//
// File: src/daemon/resources/remote_desktop/transport/webrtc.rs
...
use crate::daemon::resources::remote_desktop::sdp::remote_ice_candidate_inits;
use crate::daemon::resources::remote_desktop::session_store::RemoteDesktopSessionStore;
use crate::daemon::resources::remote_desktop::transport::RemoteDesktopTransportManager;
...
#[derive(Clone)]
pub(in crate::daemon::resources::remote_desktop) struct DirectWebRtcHandler {
...
pub(in crate::daemon::resources::remote_desktop) fn apply_remote_ice_candidate_values(
...
pub(in crate::daemon::resources::remote_desktop) fn apply_pending_remote_ice_candidates(
