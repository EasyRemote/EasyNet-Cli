...
// =================================================
//
// File: src/daemon/resources/remote_desktop/transport/webrtc_baseline_media.rs
...
pub(in crate::daemon::resources::remote_desktop) struct BaselineMediaInputs<'a> {
    pub(in crate::daemon::resources::remote_desktop) track: &'a Arc<TrackLocalStaticSample>,
    pub(in crate::daemon::resources::remote_desktop) ssrc: u32,
    pub(in crate::daemon::resources::remote_desktop) options: &'a ScreenCaptureOptions,
    pub(in crate::daemon::resources::remote_desktop) config: &'a BuiltinH264Config,
}

pub(in crate::daemon::resources::remote_desktop) async fn run_direct_webrtc_recorder_stream(
...
pub(in crate::daemon::resources::remote_desktop) async fn run_direct_webrtc_polling_stream(
    inputs: &BaselineMediaInputs<'_>,
    entry: &ResourceEntry,
    done_rx: &mut webrtc::runtime::Receiver<()>,
    stop_rx: &mut watch::Receiver<bool>,
