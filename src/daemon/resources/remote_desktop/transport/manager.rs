...
// ===============================================
//
// File: src/daemon/resources/remote_desktop/transport/manager.rs
...
#[derive(Clone)]
pub(in crate::daemon::resources::remote_desktop) struct DirectWebRtcEndpoint {
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopTransportManager {
...
impl RemoteDesktopTransportManager {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn replace_endpoint(
        &self,
        session_id: String,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn endpoint(
        &self,
        session_id: &str,
    ) -> Option<DirectWebRtcEndpoint> {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn stop_endpoint(&self, session_id: &str) {
    ...
    #[cfg(test)]
    pub(in crate::daemon::resources::remote_desktop) fn clear_endpoints(&self) {
        self.endpoints().clear();
    }

    pub(in crate::daemon::resources::remote_desktop) fn block_on<F: Future>(
        &self,
        future: F,
    ) -> F::Output {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn spawn<F>(
        &self,
        future: F,
