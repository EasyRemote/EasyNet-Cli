...
// =============================================
//
// File: src/daemon/resources/remote_desktop/transport/terminal.rs
...
pub(in crate::daemon::resources::remote_desktop) struct BidiTerminalGuard {
    sent: Arc<AtomicBool>,
}
...
impl BidiTerminalGuard {
    ...
    pub(in crate::daemon::resources::remote_desktop) async fn send_closed(
        &self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn send_blocking_closed(
        &self,
        to_client: &mpsc::Sender<BidiOutputFrame>,
        reason: &'static str,
    ) -> bool {
    ...
    pub(in crate::daemon::resources::remote_desktop) async fn send_error(
        &self,
        to_client: &mpsc::Sender<BidiOutputFrame>,
        code: &'static str,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn send_blocking_error(
        &self,
        to_client: &mpsc::Sender<BidiOutputFrame>,
        code: &'static str,
        message: impl Into<String>,
