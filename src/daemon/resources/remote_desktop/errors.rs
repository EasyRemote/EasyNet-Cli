...
// ==========================================
//
// File: src/daemon/resources/remote_desktop/errors.rs
...
pub(in crate::daemon::resources::remote_desktop) enum RemoteDesktopError {
...
pub(in crate::daemon::resources::remote_desktop) type RemoteDesktopResult<T> =
