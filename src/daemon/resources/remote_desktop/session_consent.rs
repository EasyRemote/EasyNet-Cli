...
// ============================================
//
// File: src/daemon/resources/remote_desktop/session_consent.rs
// Description: Immutable local-user consent grant captured at session creation.

use serde_json::{json, Value};

use crate::daemon::ability::dispatch::EnvelopeContext;
use crate::daemon::resources::remote_desktop::errors::{RemoteDesktopError, RemoteDesktopResult};
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopConsentReceipt {
    receipt_ura: String,
    receipt_hash: String,
}
...
impl RemoteDesktopConsentReceipt {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn receipt_ura(&self) -> &str {
        &self.receipt_ura
    }
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopConsentGrant {
    policy: &'static str,
...
impl RemoteDesktopConsentGrant {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn required_from_envelope(
        ability: &'static str,
        session_id: &str,
        env: &EnvelopeContext,
    ...
    #[cfg(test)]
    pub(in crate::daemon::resources::remote_desktop) fn from_envelope_for_test(
        env: &EnvelopeContext,
    ) -> Self {
        Self {
            policy: POLICY_LOCAL_USER_CONSENT,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn approval_receipt(
        &self,
...
pub(in crate::daemon::resources::remote_desktop) fn causal_context_contains_receipt(
