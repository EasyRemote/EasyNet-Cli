...
// ======================================================
//
// File: src/daemon/resources/remote_desktop/resource.rs
...
pub(in crate::daemon::resources::remote_desktop) fn resolve_screen_resource_from_envelope(
    ability: &'static str,
    env: &EnvelopeContext,
    args: &Value,
...
pub(in crate::daemon::resources::remote_desktop) fn resolve_screen_resource(
    ability: &str,
    subject: &str,
) -> anyhow::Result<ResourceEntry> {
