...
// ====================================================
//
// File: src/daemon/resources/remote_desktop/view_device.rs
...
pub(in crate::daemon::resources::remote_desktop) fn quality_targets(video: &Value) -> Value {
    json!({
...
pub(in crate::daemon::resources::remote_desktop) fn device_capabilities_view() -> Value {
...
pub(in crate::daemon::resources::remote_desktop) fn empty_pipeline_metrics() -> Value {
    json!({
        "observed_fps": 0,
