...
// ========================================
//
// File: src/daemon/resources/remote_desktop/input.rs
...
pub(in crate::daemon::resources::remote_desktop) fn apply_input_frame_with_policy(
    input_policy: &Value,
...
pub(in crate::daemon::resources::remote_desktop) fn input_policy_for_entry(
...
/// emitted on close.
pub(in crate::daemon::resources::remote_desktop) async fn run_remote_desktop_input_channel(
...
pub(in crate::daemon::resources::remote_desktop) fn input_policy_allows(
    policy: &Value,
    frame_type: &str,
) -> bool {
