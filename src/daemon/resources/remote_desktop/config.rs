...
// ===================================================
//
// File: src/daemon/resources/remote_desktop/config.rs
...
pub(in crate::daemon::resources::remote_desktop) const MIN_FRAME_QUEUE_DEPTH: usize = 1;
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopRuntimeConfig {
    max_sessions: usize,
...
impl RemoteDesktopRuntimeConfig {
    ...
    pub(in crate::daemon::resources::remote_desktop) const fn max_sessions(self) -> usize {
        self.max_sessions
    }

    /// Maximum downstream media/control frames buffered per attached session.
    pub(in crate::daemon::resources::remote_desktop) const fn max_frame_queue(self) -> usize {
