...
// ===============================================
//
// File: src/daemon/resources/remote_desktop/event_log.rs
...
pub(in crate::daemon::resources::remote_desktop) const MAX_EVENTS_PER_SESSION: usize = 256;
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopEventRecord {
    value: Value,
}
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopEventLog {
...
impl RemoteDesktopEventLog {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn subscribe(
        &self,
    ) -> broadcast::Receiver<Value> {
        self.event_tx.subscribe()
    }

    pub(in crate::daemon::resources::remote_desktop) fn push(
        &mut self,
        session_id: &str,
...
pub(in crate::daemon::resources::remote_desktop) fn event_type_proto_name(
    event_type: &str,
) -> &'static str {
    match event_type {
