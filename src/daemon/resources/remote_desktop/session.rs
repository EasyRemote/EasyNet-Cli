...
// ==========================================
//
// File: src/daemon/resources/remote_desktop/session.rs
...
use crate::daemon::resources::remote_desktop::constants::REASON_SESSION_EXPIRED;
use crate::daemon::resources::remote_desktop::event_log::RemoteDesktopEventLog;
use crate::daemon::resources::remote_desktop::request::{
    RemoteDesktopInputPolicy, RemoteDesktopVideoConstraints,
};
use crate::daemon::resources::remote_desktop::session_events;
pub(in crate::daemon::resources::remote_desktop) use crate::daemon::resources::remote_desktop::session_identity::RemoteDesktopSessionInit;
use crate::daemon::resources::remote_desktop::session_identity::RemoteDesktopSessionProfile;
use crate::daemon::resources::remote_desktop::session_lease::RemoteDesktopLease;
use crate::daemon::resources::remote_desktop::session_signaling::RemoteDesktopSignalingState;
use crate::daemon::resources::remote_desktop::session_state::RemoteDesktopSessionStateMachine;
pub(in crate::daemon::resources::remote_desktop) use crate::daemon::resources::remote_desktop::session_state::RemoteDesktopState;
use crate::daemon::resources::remote_desktop::session_transport_state::RemoteDesktopTransportState;
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopSession {
...
impl RemoteDesktopSession {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn new(
    ...
    pub(in crate::daemon::resources::remote_desktop) fn session_id(&self) -> &str {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn matches_session_token(
        &self,
        token: &str,
    ) -> bool {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn session_token_for_create_response(
        &self,
    ) -> &str {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn creator_caller_ura(&self) -> Option<&str> {
        self.profile.creator_caller_ura()
    }

    /// Immutable local-user consent grant captured at creation.
    pub(in crate::daemon::resources::remote_desktop) fn consent(
        &self,
    ) -> &crate::daemon::resources::remote_desktop::session_consent::RemoteDesktopConsentGrant {
        self.profile.consent()
    }

    /// Canonical resource URA that this session is allowed to operate on.
    pub(in crate::daemon::resources::remote_desktop) fn subject_ura(&self) -> &str {
        self.profile.subject_ura()
    }

    /// Resource type captured at session creation.
    pub(in crate::daemon::resources::remote_desktop) fn subject_type(&self) -> ResourceType {
        self.profile.subject_type()
    }

    /// Human-facing display name for the acted-on resource.
    pub(in crate::daemon::resources::remote_desktop) fn subject_display_name(&self) -> &str {
        self.profile.subject_display_name()
    }

    /// Requested session mode.
    pub(in crate::daemon::resources::remote_desktop) fn mode(&self) -> &str {
        self.profile.mode()
    }

    /// Current lifecycle state.
    pub(in crate::daemon::resources::remote_desktop) fn state(&self) -> RemoteDesktopState {
        self.lifecycle.state()
    }

    /// Whether this session is terminal and must not mutate transport state.
    pub(in crate::daemon::resources::remote_desktop) fn is_terminal(&self) -> bool {
        self.lifecycle.is_terminal()
    }

    /// Creation timestamp in Unix milliseconds.
    pub(in crate::daemon::resources::remote_desktop) fn created_at_ms(&self) -> u64 {
        self.lease.created_at_ms()
    }

    /// Last mutation timestamp in Unix milliseconds.
    pub(in crate::daemon::resources::remote_desktop) fn updated_at_ms(&self) -> u64 {
        self.lease.updated_at_ms()
    }

    /// Current lease deadline in Unix milliseconds.
    pub(in crate::daemon::resources::remote_desktop) fn lease_expires_at_ms(&self) -> u64 {
        self.lease.expires_at_ms()
    }

    /// Whether the lease has elapsed at `now`.
    pub(in crate::daemon::resources::remote_desktop) fn is_expired_at(&self, now: u64) -> bool {
        self.lease.is_expired_at(now)
    }

    /// Ordered transport preference list captured at session creation.
    pub(in crate::daemon::resources::remote_desktop) fn transport_preferences(&self) -> &[String] {
        self.profile.transport_preferences()
    }

    /// Video constraints captured at session creation.
    pub(in crate::daemon::resources::remote_desktop) fn video(
        &self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn input_policy(
        &self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn media_transport_ready(&self) -> bool {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn media_stats(&self) -> Option<Value> {
        self.transport.media_stats()
    }

    /// Whether the diagnostic preview transport is attached.
    pub(in crate::daemon::resources::remote_desktop) fn preview_attached(&self) -> bool {
        self.transport.preview_attached()
    }

    /// Bounded event-log projection.
    pub(in crate::daemon::resources::remote_desktop) fn events(&self) -> Vec<Value> {
        self.event_log.events()
    }

    /// Subscribe to live session events without exposing the sender.
    pub(in crate::daemon::resources::remote_desktop) fn subscribe_events(
        &self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn end_reason(&self) -> Option<&str> {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn add_remote_ice_candidate(
        &mut self,
        candidate: Value,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn attach_preview_transport(
        &mut self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn refresh_lease(
        &mut self,
        now: u64,
        lease_ttl_ms: u64,
    ) -> u64 {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn mark_transport_blocked(
        &mut self,
        reason: &str,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn record_local_ice_candidate(
        &mut self,
        candidate: Value,
    ) {
        if self.lifecycle.is_terminal() {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn record_input_channel_event(
        &mut self,
        event_type: &str,
        payload: Value,
    ) {
    ...
    #[cfg(target_os = "macos")]
    pub(in crate::daemon::resources::remote_desktop) fn record_media_stats(
        &mut self,
        stats: Value,
    ) {
        if self.lifecycle.is_terminal() {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn detach_preview_transport(
        &mut self,
    ) -> Option<watch::Sender<bool>> {
    ...
    #[cfg(test)]
    pub(in crate::daemon::resources::remote_desktop) fn install_preview_transport_for_test(
        &mut self,
        stop_tx: watch::Sender<bool>,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::daemon::resources::remote_desktop) fn set_lease_expires_at_for_test(
        &mut self,
    ...
    pub(in crate::daemon::resources::remote_desktop) fn close(&mut self, reason: &str) {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn expire(&mut self, now: u64) {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn mark_webrtc_connected(
        &mut self,
        endpoint_ura: String,
    ) {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn mark_webrtc_failed(
        &mut self,
        reason: &str,
        message: String,
    ) {
...
pub(in crate::daemon::resources::remote_desktop) fn now_ms() -> u64 {
    SystemTime::now()
