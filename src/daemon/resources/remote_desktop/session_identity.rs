...
// =============================================
//
// File: src/daemon/resources/remote_desktop/session_identity.rs
...
use crate::daemon::resources::remote_desktop::session_consent::RemoteDesktopConsentGrant;
...
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopSessionInit {
    pub(in crate::daemon::resources::remote_desktop) session_id: String,
    pub(in crate::daemon::resources::remote_desktop) session_token: String,
    pub(in crate::daemon::resources::remote_desktop) creator_caller_ura: Option<String>,
    pub(in crate::daemon::resources::remote_desktop) consent: RemoteDesktopConsentGrant,
    pub(in crate::daemon::resources::remote_desktop) subject_ura: String,
    pub(in crate::daemon::resources::remote_desktop) subject_type: ResourceType,
    pub(in crate::daemon::resources::remote_desktop) subject_display_name: String,
    pub(in crate::daemon::resources::remote_desktop) mode: String,
    pub(in crate::daemon::resources::remote_desktop) lease_ttl_ms: u64,
    pub(in crate::daemon::resources::remote_desktop) transport_preferences: Vec<String>,
    pub(in crate::daemon::resources::remote_desktop) video: RemoteDesktopVideoConstraints,
    pub(in crate::daemon::resources::remote_desktop) input_policy: RemoteDesktopInputPolicy,
}
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct RemoteDesktopSessionProfile {
    session_id: String,
...
impl RemoteDesktopSessionProfile {
    ...
    pub(in crate::daemon::resources::remote_desktop) fn from_init(
