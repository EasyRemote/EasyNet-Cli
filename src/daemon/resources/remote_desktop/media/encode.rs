...
// ===========================================
//
// File: src/daemon/resources/remote_desktop/media/encode.rs
...
use crate::daemon::resources::remote_desktop::config::MIN_FRAME_QUEUE_DEPTH;
...
pub(in crate::daemon::resources::remote_desktop) const DIAGNOSTIC_RELAY_GOP_MAX_FRAMES: u32 = 15;
...
#[derive(Debug, Clone)]
pub(in crate::daemon::resources::remote_desktop) struct BuiltinH264Config {
    pub(in crate::daemon::resources::remote_desktop) backend: RemoteDesktopMediaBackendDescriptor,
    pub(in crate::daemon::resources::remote_desktop) requested_fps: u32,
    pub(in crate::daemon::resources::remote_desktop) fps: u32,
    pub(in crate::daemon::resources::remote_desktop) bitrate_kbps: u32,
    #[cfg_attr(not(target_os = "macos"), allow(dead_code))]
    pub(in crate::daemon::resources::remote_desktop) max_frame_queue_depth: usize,
    pub(in crate::daemon::resources::remote_desktop) keyframe_interval_frames: u32,
}
...
pub(in crate::daemon::resources::remote_desktop) enum BuiltinH264StreamTerminal {
    Closed(&'static str),
    Failed {
        reason: &'static str,
        message: String,
...
pub(in crate::daemon::resources::remote_desktop) type BuiltinH264TerminalCallback =
    Arc<dyn Fn(BuiltinH264StreamTerminal) + Send + Sync + 'static>;

pub(in crate::daemon::resources::remote_desktop) fn spawn_builtin_h264_stream(
    entry: ResourceEntry,
...
pub(in crate::daemon::resources::remote_desktop) fn build_builtin_h264_config(
    entry: &ResourceEntry,
    options: &ScreenCaptureOptions,
    max_frame_queue_depth: usize,
...
pub(in crate::daemon::resources::remote_desktop) fn build_direct_webrtc_h264_config(
    entry: &ResourceEntry,
    options: &ScreenCaptureOptions,
...
pub(in crate::daemon::resources::remote_desktop) fn latest_recorder_frame(
...
pub(in crate::daemon::resources::remote_desktop) fn build_openh264_encoder(
    config: &BuiltinH264Config,
...
pub(in crate::daemon::resources::remote_desktop) fn encode_openh264_frame(
    encoder: &mut Encoder,
    frame: &RawRgbFrame,
    seq: u64,
    fps: u32,
...
pub(in crate::daemon::resources::remote_desktop) fn even_rgb_frame(
    frame: RawRgbFrame,
) -> RawRgbFrame {
...
pub(in crate::daemon::resources::remote_desktop) async fn write_h264_sample(
...
mod tests {
    ...
    use crate::daemon::resources::remote_desktop::test_support::seed_xcap_display;
