...
fn dispatch_terminal_failure_payload(message: &str, duration_ms: u64) -> serde_json::Value {
    ...
    let class = crate::daemon::execution::mission::failure_codes::FailureCodeClassifier::classify_error_class(&code);
...
mod tests {
    ...
    struct MockAdapter {
        ...
        response: String,
        usage: Option<crate::daemon::execution::mission::dispatch::AgentUsage>,
        tool_calls: Vec<crate::daemon::execution::mission::dispatch::ToolCall>,
    }

    impl crate::daemon::execution::mission::adapter::AgentAdapter for MockAdapter {
        ...
        fn invoke(
            ...
            _entry: &AgentEntry,
            _prompt: &str,
            _opts: crate::daemon::execution::mission::adapter::InvokeOpts,
    ...
    fn mock_adapter_returns_its_scripted_response() {
        ...
        let entry = dummy_entry();
        let opts = crate::daemon::execution::mission::adapter::InvokeOpts {
    ...
    fn simulate_driver_progress(
        timeline: &crate::daemon::execution::mission::timeline::TimelineWriter,
        driver: &str,
        line: &str,
    ) {
    ...
    fn timeline_progress_events_carry_driver_and_chunk_shape() {
        ...
        use crate::daemon::execution::mission::session::Session;
        let _g = crate::cli::commands::test_support::HomeGuard::new();
        let session = Session::new(None);
