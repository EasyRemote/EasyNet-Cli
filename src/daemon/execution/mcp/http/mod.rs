...
// =========================================================
//
// File: src/daemon/execution/mcp/http/mod.rs
//
// Per MCP spec 2025-06-18 §"Streamable HTTP" transport. Sibling of
// the stdio transport in `mcp/mod.rs`.
//
// Module layout
// -------------
...
mod tests {
    use super::*;
    use crate::daemon::execution::mcp::McpServerSpec;
    ...
    fn tls_spec_round_trips_through_serde() {
        use crate::daemon::execution::mcp::{AuthSpec, TlsSpec};
    ...
    fn validate_rejects_https_options_on_plain_http() {
        use crate::daemon::execution::mcp::TlsSpec;
        let spec = McpServerSpec {
            name: "mismatch".into(),
            transport: "http".into(),
            url: Some("http://127.0.0.1:3001".into()),
