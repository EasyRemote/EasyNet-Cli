...
use crate::facade::cli::daemon_agent_view::{AgentRuntimeKind, DaemonAgentRow};
...
pub(super) fn invoke_daemon_agent_list_required(
    ...
    crate::facade::cli::daemon_agent_view::list_agents_with_client(client)
}
...
pub(super) fn daemon_row_root(row: &DaemonAgentRow) -> std::path::PathBuf {
    crate::facade::cli::daemon_agent_view::agent_root(row)
}
