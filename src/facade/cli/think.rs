...
use crate::facade::cli::mission_runs::LegacyMissionContext;
...
pub struct ThinkArgs {
    ...
    /// action. Default: 120 s (`support::timeouts::THINK_DEFAULT_SECS`).
...
pub fn run(args: ThinkArgs) -> anyhow::Result<()> {
    ...
    // invariant (see runtime::dispatch::check_mission_context_invariant)
