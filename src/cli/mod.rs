...
/// and `cli::completion::run::<App>(...)` can reference it
...
\x1b[1;36mCommands:\x1b[0m
  ...
  \x1b[1;36m[Network]\x1b[0m
    \x1b[1mdevice\x1b[0m               Manage remote devices — pair, list, abilities, exec
...
pub enum Command {
    ...
    // ── Network (20-29) ──────────────────────────────────────────────────
    /// Manage remote devices — pair, list, abilities, exec.
    ...
    fn help_template_lists_every_command_in_enum() {
        ...
        assert!(
            ...
            "HELP_TEMPLATE drifted from `Command` enum.\n  \
             ...
             extra in template: {:?}\n\
             update HELP_TEMPLATE in src/cli/mod.rs to match.",
