...
// =================================================
//
// File: src/plugins/builtin/remote_desktop/invoke_bidi.rs
...
pub(in crate::plugins::builtin::remote_desktop) struct BidiCaptureWorkerConfig {
    ...
    pub(in crate::plugins::builtin::remote_desktop) backend: Arc<dyn ScreenSnapshotBackend>,
    ...
    pub(in crate::plugins::builtin::remote_desktop) encoding: AttachEncoding,
    pub(in crate::plugins::builtin::remote_desktop) input_policy: Value,
    pub(in crate::plugins::builtin::remote_desktop) from_client: mpsc::Receiver<Value>,
    pub(in crate::plugins::builtin::remote_desktop) to_client: mpsc::Sender<BidiOutputFrame>,
    pub(in crate::plugins::builtin::remote_desktop) stop_tx: watch::Sender<bool>,
    pub(in crate::plugins::builtin::remote_desktop) stop_rx: watch::Receiver<bool>,
    pub(in crate::plugins::builtin::remote_desktop) max_frame_queue_depth: usize,
}

pub(in crate::plugins::builtin::remote_desktop) fn spawn_bidi_capture_worker(
...
pub(in crate::plugins::builtin::remote_desktop) fn handle_bidi_input_frame(
    input_policy: &Value,
    frame: Value,
) -> Value {
                ...
                "ping" => {
                    let _ = to_client
                        .send(BidiOutputFrame::json(json!({
                            "type": "pong",
                            "at_ms": crate::plugins::remote_desktop::session::now_ms(),
                        })))
                        .await;
                }
...
fn install_h264_preview_session_for_test(
    ...
    session_store.with_sessions(|sessions| {
        let mut session = crate::plugins::remote_desktop::session::RemoteDesktopSession::new(
            crate::plugins::remote_desktop::session::RemoteDesktopSessionInit {
                ...
                video:
                    crate::plugins::remote_desktop::request::RemoteDesktopVideoConstraints::default(
                    ),
                input_policy:
                    crate::plugins::remote_desktop::request::RemoteDesktopInputPolicy::default(),
            },
        );
