...
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopRuntimeConfig {
    max_sessions: usize,
...
impl RemoteDesktopRuntimeConfig {
    ...
    pub(in crate::plugins::builtin::remote_desktop) const fn max_sessions(self) -> usize {
        self.max_sessions
    }

    /// Maximum downstream media/control frames buffered per attached session.
    pub(in crate::plugins::builtin::remote_desktop) const fn max_frame_queue(self) -> usize {
