...
// ===========================================
//
// File: src/plugins/builtin/remote_desktop/session_store.rs
...
use crate::plugins::remote_desktop::constants::DIRECT_WEBRTC_ENDPOINT_PREFIX;
...
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopSessionStore {
...
impl RemoteDesktopSessionStore {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn lock(
        &self,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn with_sessions<R>(
        &self,
    ...
    /// connection checks.
    pub(in crate::plugins::builtin::remote_desktop) fn mark_direct_webrtc_connected(
        &self,
        session_id: &str,
    ) {
        let mut sessions = self.lock();
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn mark_direct_webrtc_failed(
        &self,
        session_id: &str,
        reason: &str,
        message: String,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn record_local_webrtc_candidate(
        &self,
        session_id: &str,
        candidate: Value,
    ) {
