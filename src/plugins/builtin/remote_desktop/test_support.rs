...
// ==========================================
//
// File: src/plugins/builtin/remote_desktop/test_support.rs
...
use crate::plugins::remote_desktop::constants::DEFAULT_FRAME_QUEUE_DEPTH;
...
pub(in crate::plugins::builtin::remote_desktop) fn test_lock() -> MutexGuard<'static, ()> {
    REMOTE_DESKTOP_TEST_LOCK
        .lock()
        .unwrap_or_else(|poisoned| poisoned.into_inner())
}

pub(in crate::plugins::builtin::remote_desktop) fn test_plugin() -> Arc<RemoteDesktopPlugin> {
...
pub(in crate::plugins::builtin::remote_desktop) fn test_runtime_limits() -> PluginRuntimeLimits {
    PluginRuntimeLimits::new(128, DEFAULT_FRAME_QUEUE_DEPTH as usize)
}

pub(in crate::plugins::builtin::remote_desktop) fn reset_store(plugin: &RemoteDesktopPlugin) {
...
pub(in crate::plugins::builtin::remote_desktop) fn env_for(subject: &str) -> EnvelopeContext {
    env_for_caller(subject, "easynet:///r/acme/user/test-caller")
}

pub(in crate::plugins::builtin::remote_desktop) fn env_for_caller(
    subject: &str,
    caller: &str,
) -> EnvelopeContext {
...
pub(in crate::plugins::builtin::remote_desktop) fn seed_display(
...
pub(in crate::plugins::builtin::remote_desktop) fn seed_xcap_display(
    file: &mut ResourcesFile,
    hardware_id: &str,
) -> String {
    upsert_resource(
...
pub(in crate::plugins::builtin::remote_desktop) fn seed_window(
    file: &mut ResourcesFile,
    hardware_id: &str,
) -> String {
    upsert_resource(
