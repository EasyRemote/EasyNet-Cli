...
// ==========================================
//
// File: src/plugins/builtin/remote_desktop/session.rs
...
use crate::plugins::remote_desktop::constants::REASON_SESSION_EXPIRED;
use crate::plugins::remote_desktop::event_log::RemoteDesktopEventLog;
use crate::plugins::remote_desktop::request::{
    RemoteDesktopInputPolicy, RemoteDesktopVideoConstraints,
};
use crate::plugins::remote_desktop::session_events;
pub(in crate::plugins::builtin::remote_desktop) use crate::plugins::remote_desktop::session_identity::RemoteDesktopSessionInit;
use crate::plugins::remote_desktop::session_identity::RemoteDesktopSessionProfile;
use crate::plugins::remote_desktop::session_lease::RemoteDesktopLease;
use crate::plugins::remote_desktop::session_signaling::RemoteDesktopSignalingState;
use crate::plugins::remote_desktop::session_state::RemoteDesktopSessionStateMachine;
pub(in crate::plugins::builtin::remote_desktop) use crate::plugins::remote_desktop::session_state::RemoteDesktopState;
use crate::plugins::remote_desktop::session_transport_state::RemoteDesktopTransportState;
...
#[derive(Debug, Clone)]
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopSession {
...
impl RemoteDesktopSession {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn new(init: RemoteDesktopSessionInit) -> Self {
        let now = now_ms();
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn consent(
        &self,
    ) -> &crate::plugins::remote_desktop::session_consent::RemoteDesktopConsentGrant {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn lease_expires_at_ms(&self) -> u64 {
        self.lease.expires_at_ms()
    }

    /// Whether the lease has elapsed at `now`.
    pub(in crate::plugins::builtin::remote_desktop) fn is_expired_at(&self, now: u64) -> bool {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn local_description(&self) -> Option<Value> {
        self.signaling.local_description()
    }

    /// Remote SDP description received from the caller.
    pub(in crate::plugins::builtin::remote_desktop) fn remote_description(&self) -> Option<Value> {
        self.signaling.remote_description()
    }

    /// Remote ICE candidates accepted for this session.
    pub(in crate::plugins::builtin::remote_desktop) fn remote_ice_candidates(&self) -> Vec<Value> {
        self.signaling.remote_ice_candidates()
    }

    /// Local ICE candidates produced by the device-side endpoint.
    pub(in crate::plugins::builtin::remote_desktop) fn local_ice_candidates(&self) -> Vec<Value> {
        self.signaling.local_ice_candidates()
    }

    /// Latest ICE state reported by the WebRTC backend.
    pub(in crate::plugins::builtin::remote_desktop) fn webrtc_ice_state(&self) -> Option<&str> {
        self.signaling.webrtc_ice_state()
    }

    /// Latest transport/backend error reason.
    pub(in crate::plugins::builtin::remote_desktop) fn webrtc_error(&self) -> Option<&str> {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn negotiated_codec(&self) -> Option<Value> {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn subscribe_events(
        &self,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn set_description(
        &mut self,
        side: &str,
        description: Value,
    ) -> anyhow::Result<()> {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn add_remote_ice_candidate(
        &mut self,
        candidate: Value,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn refresh_lease(
        &mut self,
        now: u64,
        lease_ttl_ms: u64,
    ) -> u64 {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn mark_transport_blocked(
        &mut self,
        reason: &str,
    ...
    /// connectivity.
    pub(in crate::plugins::builtin::remote_desktop) fn set_local_webrtc_answer(
        &mut self,
        answer: Value,
        backend_id: &str,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn record_local_ice_candidate(
        &mut self,
        candidate: Value,
    ) {
        if self.lifecycle.is_terminal() {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn record_webrtc_diagnostic(
        &mut self,
        event_type: &str,
        error: Option<String>,
        payload: Value,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn record_input_channel_event(
        &mut self,
        event_type: &str,
        payload: Value,
    ) {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn detach_preview_transport_from_worker(
        &mut self,
        reason: &str,
    ) -> Option<watch::Sender<bool>> {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn mark_preview_transport_failed(
        &mut self,
        reason: &str,
        message: String,
    ) -> Option<watch::Sender<bool>> {
    ...
    #[cfg(test)]
    pub(in crate::plugins::builtin::remote_desktop) fn set_lease_expires_at_for_test(
        &mut self,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn close(&mut self, reason: &str) {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn expire(&mut self, now: u64) {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn mark_webrtc_connected(
        &mut self,
        endpoint_ura: String,
    ) {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn mark_webrtc_failed(
        &mut self,
        reason: &str,
        message: String,
    ) {
...
pub(in crate::plugins::builtin::remote_desktop) fn now_ms() -> u64 {
    SystemTime::now()
