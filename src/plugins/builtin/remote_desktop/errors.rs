...
// ==========================================
//
// File: src/plugins/builtin/remote_desktop/errors.rs
...
pub(in crate::plugins::builtin::remote_desktop) enum RemoteDesktopError {
...
pub(in crate::plugins::builtin::remote_desktop) type RemoteDesktopResult<T> =
