...
// ===============================================
//
// File: src/plugins/builtin/remote_desktop/transport/webrtc_negotiation.rs
...
pub(in crate::plugins::builtin::remote_desktop) struct RemoteOfferNegotiation {
    pub(in crate::plugins::builtin::remote_desktop) plugin: Arc<RemoteDesktopPlugin>,
    pub(in crate::plugins::builtin::remote_desktop) access_env: EnvelopeContext,
    pub(in crate::plugins::builtin::remote_desktop) access_args: Value,
    pub(in crate::plugins::builtin::remote_desktop) session_id: String,
    pub(in crate::plugins::builtin::remote_desktop) side: String,
    pub(in crate::plugins::builtin::remote_desktop) description: Value,
...
pub(in crate::plugins::builtin::remote_desktop) fn negotiate_remote_offer(
