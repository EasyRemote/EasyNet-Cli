...
// =======================================
//
// File: src/plugins/builtin/remote_desktop/transport/webrtc_media.rs
...
use crate::plugins::remote_desktop::transport::webrtc_baseline_media::{
...
pub(in crate::plugins::builtin::remote_desktop) struct DirectWebRtcSession {
    ...
    pub(in crate::plugins::builtin::remote_desktop) track: Arc<TrackLocalStaticSample>,
    ...
    pub(in crate::plugins::builtin::remote_desktop) config: BuiltinH264Config,
}

pub(in crate::plugins::builtin::remote_desktop) async fn run_direct_webrtc_media_loop(
