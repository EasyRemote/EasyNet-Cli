...
// =================================================
//
// File: src/plugins/builtin/remote_desktop/transport/webrtc.rs
...
use crate::plugins::remote_desktop::sdp::remote_ice_candidate_inits;
use crate::plugins::remote_desktop::session_store::RemoteDesktopSessionStore;
use crate::plugins::remote_desktop::transport::RemoteDesktopTransportManager;
...
#[derive(Clone)]
pub(in crate::plugins::builtin::remote_desktop) struct DirectWebRtcHandler {
...
pub(in crate::plugins::builtin::remote_desktop) fn apply_remote_ice_candidate_values(
...
pub(in crate::plugins::builtin::remote_desktop) fn apply_pending_remote_ice_candidates(
