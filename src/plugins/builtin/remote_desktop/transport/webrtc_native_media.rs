...
// ==============================================
//
// File: src/plugins/builtin/remote_desktop/transport/webrtc_native_media.rs
...
use crate::plugins::remote_desktop::screencapturekit_capture::{
...
pub(in crate::plugins::builtin::remote_desktop) struct NativeMediaInputs<'a> {
...
pub(in crate::plugins::builtin::remote_desktop) async fn run_direct_webrtc_native_stream(
    ...
    let encoder_notify = StdArc::new(move || encoder_wakeup_for_callback.notify_one())
        as crate::plugins::remote_desktop::videotoolbox_encoder::EncoderWakeup;
    ...
    let sink: crate::plugins::remote_desktop::screencapturekit_capture::FrameSink =
