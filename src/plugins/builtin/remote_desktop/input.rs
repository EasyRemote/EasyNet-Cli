...
// ========================================
//
// File: src/plugins/builtin/remote_desktop/input.rs
...
/// emitted on close.
pub(in crate::plugins::builtin::remote_desktop) async fn run_remote_desktop_input_channel(
...
pub(in crate::plugins::builtin::remote_desktop) fn input_policy_allows(
    policy: &Value,
    frame_type: &str,
) -> bool {
