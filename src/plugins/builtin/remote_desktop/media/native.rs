...
// ==================================================
//
// File: src/plugins/builtin/remote_desktop/media/native.rs
...
#[cfg(target_os = "macos")]
use crate::runtime::agents::media::screen_snapshot::VideoResolution;
...
#[cfg(target_os = "macos")]
#[derive(Debug)]
pub(in crate::plugins::builtin::remote_desktop) struct NativeAdaptiveBitrate {
    pub(in crate::plugins::builtin::remote_desktop) target_kbps: u32,
    pub(in crate::plugins::builtin::remote_desktop) current_kbps: u32,
    pub(in crate::plugins::builtin::remote_desktop) min_kbps: u32,
...
impl NativeAdaptiveBitrate {
    pub(in crate::plugins::builtin::remote_desktop) fn new(target_kbps: u32) -> Self {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn update(
        &mut self,
        input_dropped: u64,
        output_dropped: u64,
        queued_units: usize,
...
#[cfg(target_os = "macos")]
#[derive(Debug, Default)]
pub(in crate::plugins::builtin::remote_desktop) struct NativeLatencyStats {
...
impl NativeLatencyStats {
    pub(in crate::plugins::builtin::remote_desktop) fn record_encoded_unit(
        &mut self,
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn to_json(&self) -> Value {
        json!({
...
#[cfg(target_os = "macos")]
pub(in crate::plugins::builtin::remote_desktop) async fn webrtc_stats_snapshot(
...
#[cfg(target_os = "macos")]
pub(in crate::plugins::builtin::remote_desktop) fn latest_native_rtp_units(
    units: Vec<crate::plugins::remote_desktop::videotoolbox_encoder::EncodedAccessUnit>,
    decoder_primed: bool,
) -> (
    Vec<crate::plugins::remote_desktop::videotoolbox_encoder::EncodedAccessUnit>,
    usize,
) {
    if units.len() <= 1 {
        return (units, 0);
...
#[cfg(target_os = "macos")]
pub(in crate::plugins::builtin::remote_desktop) fn is_webrtc_sender_backpressure(
...
#[cfg(target_os = "macos")]
pub(in crate::plugins::builtin::remote_desktop) fn native_rtp_sample_duration(
...
pub(in crate::plugins::builtin::remote_desktop) fn native_capture_dimensions(
    options: &crate::runtime::agents::media::screen_snapshot::ScreenCaptureOptions,
...
#[cfg(target_os = "macos")]
pub(in crate::plugins::builtin::remote_desktop) fn webrtc_cmtime(
    value: u64,
    fps: u32,
