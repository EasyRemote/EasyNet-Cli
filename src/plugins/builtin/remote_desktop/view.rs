...
// ====================================================
//
// File: src/plugins/builtin/remote_desktop/view.rs
...
use crate::plugins::remote_desktop::view_device::{
    device_capabilities_view, empty_pipeline_metrics, quality_targets,
};
use crate::plugins::remote_desktop::view_transport::RemoteDesktopTransportView;
...
pub(in crate::plugins::builtin::remote_desktop) fn serialize_session(
...
pub(in crate::plugins::builtin::remote_desktop) fn serialize_session_with_token(
    session: &RemoteDesktopSession,
) -> Value {
