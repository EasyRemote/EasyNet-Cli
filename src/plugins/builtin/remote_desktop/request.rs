...
// ============================================
//
// File: src/plugins/builtin/remote_desktop/request.rs
...
pub(in crate::plugins::builtin::remote_desktop) fn require_str<'a>(
    args: &'a Value,
    key: &str,
    ability: &str,
) -> anyhow::Result<&'a str> {
...
pub(in crate::plugins::builtin::remote_desktop) fn validate_session_id(
    session_id: &str,
) -> anyhow::Result<()> {
...
pub(in crate::plugins::builtin::remote_desktop) fn mint_session_id() -> String {
    let mut bytes = [0u8; 12];
    rand::rngs::OsRng.fill_bytes(&mut bytes);
    format!("rdp-{}", hex::encode(bytes))
}

pub(in crate::plugins::builtin::remote_desktop) fn mint_session_token() -> String {
...
pub(in crate::plugins::builtin::remote_desktop) fn parse_attach_capture_options(
    args: &Value,
