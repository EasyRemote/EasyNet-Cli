...
// ==============================================
//
// File: src/plugins/builtin/remote_desktop/handlers/mod.rs
// Description: Ability-level handler boundary for builtin remote desktop.

pub(in crate::plugins::builtin::remote_desktop) mod add_ice_candidate;
pub(in crate::plugins::builtin::remote_desktop) mod attach;
pub(in crate::plugins::builtin::remote_desktop) mod create_session;
pub(in crate::plugins::builtin::remote_desktop) mod end_session;
pub(in crate::plugins::builtin::remote_desktop) mod permission_status;
pub(in crate::plugins::builtin::remote_desktop) mod refresh_lease;
pub(in crate::plugins::builtin::remote_desktop) mod request_permission;
pub(in crate::plugins::builtin::remote_desktop) mod set_description;
pub(in crate::plugins::builtin::remote_desktop) mod show_session;
pub(in crate::plugins::builtin::remote_desktop) mod watch_events;
...
mod tests {
    ...
    use crate::plugins::remote_desktop::constants::MAX_ATTACH_FPS;
