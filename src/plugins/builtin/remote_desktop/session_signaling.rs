...
// =============================================
//
// File: src/plugins/builtin/remote_desktop/session_signaling.rs
...
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopSessionDescription {
    side: String,
    value: Value,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopIceCandidate {
    value: Value,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopNegotiatedCodec {
    codec: &'static str,
    profile: &'static str,
...
#[derive(Debug, Clone)]
pub(in crate::plugins::builtin::remote_desktop) struct RemoteDesktopSignalingState {
...
impl RemoteDesktopSignalingState {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn has_description(&self) -> bool {
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn push_remote_ice_candidate(
        &mut self,
        candidate: Value,
    ) -> usize {
        self.remote_ice_candidates
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn push_local_ice_candidate(
        &mut self,
        candidate: Value,
    ) -> usize {
        self.local_ice_candidates
    ...
    pub(in crate::plugins::builtin::remote_desktop) fn set_webrtc_error(&mut self, reason: &str) {
