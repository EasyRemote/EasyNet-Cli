...
// ====================================================
//
// File: src/plugins/builtin/remote_desktop/session_events.rs
// Description: Canonical event payload projections for remote desktop
// sessions.

use serde_json::{json, Value};

use crate::plugins::remote_desktop::constants::{TRANSPORT_INVOKE_BIDI, TRANSPORT_WEBRTC};
...
pub(in crate::plugins::builtin::remote_desktop) fn session_created() -> RemoteDesktopEventProjection
{
    (
        "SESSION_CREATED",
        json!({
...
pub(in crate::plugins::builtin::remote_desktop) fn description_set(
    side: &str,
...
pub(in crate::plugins::builtin::remote_desktop) fn local_webrtc_answer_set(
    backend_id: &str,
...
pub(in crate::plugins::builtin::remote_desktop) fn remote_ice_candidate_added(
...
pub(in crate::plugins::builtin::remote_desktop) fn preview_transport_connected(
) -> RemoteDesktopEventProjection {
    (
        "TRANSPORT_CONNECTED",
        json!({
...
pub(in crate::plugins::builtin::remote_desktop) fn preview_transport_detached(
    reason: &str,
) -> RemoteDesktopEventProjection {
    (
        "TRANSPORT_DETACHED",
...
pub(in crate::plugins::builtin::remote_desktop) fn preview_transport_failed(
    reason: &str,
    message: String,
) -> RemoteDesktopEventProjection {
    (
...
pub(in crate::plugins::builtin::remote_desktop) fn lease_refreshed(
...
pub(in crate::plugins::builtin::remote_desktop) fn transport_blocked(
    reason: &str,
...
pub(in crate::plugins::builtin::remote_desktop) fn local_ice_candidate(
    candidate: Value,
    candidate_count: usize,
    media_transport_ready: bool,
) -> RemoteDesktopEventProjection {
...
pub(in crate::plugins::builtin::remote_desktop) fn webrtc_diagnostic(
    media_transport_ready: bool,
    diagnostic: Value,
...
pub(in crate::plugins::builtin::remote_desktop) fn input_channel_diagnostic(
    media_transport_ready: bool,
    diagnostic: Value,
) -> Value {
    json!({
...
pub(in crate::plugins::builtin::remote_desktop) fn session_closing(
    reason: &str,
) -> RemoteDesktopEventProjection {
...
pub(in crate::plugins::builtin::remote_desktop) fn session_closed(
    reason: &str,
) -> RemoteDesktopEventProjection {
...
pub(in crate::plugins::builtin::remote_desktop) fn session_expired(
    reason: &str,
    lease_expires_at_ms: u64,
) -> RemoteDesktopEventProjection {
    (
...
pub(in crate::plugins::builtin::remote_desktop) fn webrtc_connected(
    endpoint_ura: String,
) -> RemoteDesktopEventProjection {
    (
        "TRANSPORT_CONNECTED",
...
pub(in crate::plugins::builtin::remote_desktop) fn webrtc_failed(
    reason: &str,
    message: String,
) -> RemoteDesktopEventProjection {
    (
