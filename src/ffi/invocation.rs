...
#[cfg(feature = "axon-pb")]
use crate::ffi::handle::lib_runtime;
...
fn invoke_with_axon_pb(
    session: std::sync::Arc<crate::ffi::handle::ClientSession>,
    raw: &str,
    out_receipt_json: *mut *mut c_char,
) -> i32 {
...
fn invocation_endpoint_for_session(
    session: &crate::ffi::handle::ClientSession,
...
mod tests {
    ...
    fn invocation_endpoint_prefers_daemon_handle_endpoint_override() {
        let session = crate::ffi::handle::ClientSession::with_control_path_only(
