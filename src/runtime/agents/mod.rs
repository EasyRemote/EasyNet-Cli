...
fn reflect_mcp_upstreams_sync(
    ...
    registry: &mut crate::runtime::ability_dispatch::AxonAbilityCatalog,
    owner_agent_ura: &str,
...
/// `Weak<AxonAbilityCatalog>` that survives daemon shutdown
/// gracefully.
///
...
fn attach_mcp_refresh_sinks_sync(
    ...
    registry: &std::sync::Arc<crate::runtime::ability_dispatch::AxonAbilityCatalog>,
    owner_agent_ura: &str,
    ...
    let fut = async move {
        ...
        for name in server_names {
            ...
            let reflected_for_server = reflected_snapshot.get(&name).cloned().unwrap_or_default();
