// EasyNet CLI — fleet.list_agents ability handler
// =================================================
//
// File: src/runtime/agents/fleet_list_agents_ability.rs
//
...
// `fleet.list_agents` is the operational view ("what runs here"),
