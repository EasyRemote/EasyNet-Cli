...
// =================================================================
//
// File: src/runtime/system_abilities/device_control/terminal/lifecycle.rs
//
...
pub fn register(
    ...
    pty: Arc<PtyService>,
    io: Option<crate::runtime::system_abilities::device_control::terminal::io::PtyIoService>,
) {
