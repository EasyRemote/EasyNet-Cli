...
// ==========================================
//
// File: src/runtime/system_abilities/device_control/ability_management/ops.rs
...
use crate::runtime::system_abilities::device_control::ability_management::registrar::{
    DeviceAbilityInstall, DeviceAbilityRegistrar, DeviceAbilityUninstall,
};
#[cfg(test)]
use crate::runtime::system_abilities::device_control::ability_management::store::DeviceAbilityStore;
use crate::runtime::system_abilities::device_control::ability_management::store::{
...
fn block_on_install(
    ...
    crate::runtime::system_abilities::device_control::ability_management::registrar::InstallState,
> {
...
) -> anyhow::Result<crate::runtime::system_abilities::device_control::ability_management::registrar::DeviceAbilityUninstallOutcome>
{
