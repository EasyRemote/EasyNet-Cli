...
// =================================================================
//
// File: src/runtime/system_abilities/device_control/ability_management/registrar.rs
//
...
use crate::runtime::system_abilities::agents::chat::build_host_stream_handler;
...
mod tests {
    ...
    async fn install_rebinds_device_ability_control_plane_record() {
        ...
        let content_hash = crate::runtime::system_abilities::device_control::ability_management::store::manifest_digest(
