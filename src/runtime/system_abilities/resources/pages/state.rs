...
// ================================================================
//
// File: src/runtime/system_abilities/resources/pages/state.rs
...
mod tests {
    ...
    fn publish_snapshot_restores_project_after_map_clear() {
        ...
        crate::runtime::system_abilities::resources::pages::publish::handle_publish(
            user,
            8787,
            "easynet.run",
        ...
        let fetched = crate::runtime::system_abilities::resources::pages::fetch::handle_fetch(
            user,
            project_id,
        ...
        crate::runtime::system_abilities::resources::pages::list_get_unpublish::handle_unpublish(
            user,
