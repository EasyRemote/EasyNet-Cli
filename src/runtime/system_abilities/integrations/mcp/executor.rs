...
// ==================================
//
// File: src/runtime/system_abilities/integrations/mcp/executor.rs
...
/// path, and
/// [`crate::runtime::system_abilities::integrations::mcp::reflective_registry::run_eager_blocking`]
/// /
/// [`crate::runtime::system_abilities::integrations::mcp::reflective_registry::McpReflectionSupervisor::attach_refresh_sinks_blocking`]
