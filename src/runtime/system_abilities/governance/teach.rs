...
// =============================================================
//
// File: src/runtime/system_abilities/governance/teach.rs
...
use crate::runtime::system_abilities::agents::lifecycle::SharedHotRegistrarCell;
    ...
    fn hot_registrar_cell_with_runtime(
        ...
        let registrar =
            crate::runtime::axon_bridge::hot_agent_registrar::HotAgentRegistrar::new_pending(
                ...
                Arc::new(
                    crate::runtime::system_abilities::agents::discover::BridgeDiscoverFederationResolver,
                ),
            );
