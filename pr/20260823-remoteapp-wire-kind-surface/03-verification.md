...
git diff --check -- src/daemon/plugins/surface.rs tools/scripts/check-remoteapp-product-closure-audit.sh tests/scripts/test_check_remoteapp_product_closure_audit.sh pr/20260823-remoteapp-wire-kind-surface
