...
- Node tests cover file, terminal, remote desktop, browser, and media wrapper
  projections plus invalid owner URA and missing session state rejection.
- Node conformance report passes `wrappers/profile_records`.
