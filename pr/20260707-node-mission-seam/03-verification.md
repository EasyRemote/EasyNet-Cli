...
- Node tests cover Mission carriers, status projection, event page projection,
  event stream projection, and path-like mission ID rejection.
- Node conformance report passes `mission/carrier_status`.
