...
The backend boundary checker still reports direct `internal/daemon_grpc`, generated Axon protobuf package, and remaining service imports. This slice tightens descriptor-bound Runtime Core draft validation only.
