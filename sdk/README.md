...
| Node / TypeScript facade | Runtime Core seam over injected transports with Health, Directory + Identity, Receipt, Publication, Host Binding, and Events profile seams; daemon providers remain unsupported |
