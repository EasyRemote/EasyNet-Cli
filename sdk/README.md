...
| Java / JVM facade | Runtime Core seam as a Maven package for typed errors, feature discovery, complete Invocation drafts, injected runtime transport, `CompletableFuture` async adapters, iterator-backed bounded stream/bidi state, Health DTO/client seams, Directory + Identity DTO/client seams including directory subscription carriers/projections over injected stream handles, and Receipt DTO/client seams; daemon providers remain unsupported |
