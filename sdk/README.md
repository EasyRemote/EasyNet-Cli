...
| C ABI v7 | exact generic lifecycle, Invocation, stream/bidi, health, Addressing and memory boundary |
...
ABI v7 is a hard major cut. The authoritative header and export list are:
