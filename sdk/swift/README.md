...
provider, generated DTOs for every profile, provider-backed evidence, or product
cutover evidence. Swift Package Manager metadata exists for this seam, is
verified by `tools/scripts/check-swift-sdk-seam.sh`, and declares only directly
