...
| Node/TypeScript | P1 | desktop tools and extensions | seam for Runtime Core prepare/sign/submit handles, Health, Directory + Identity, Receipt, Publication, and Host Binding DTO/client lifecycle over injected transports; daemon providers, local daemon signing, and remaining profile clients unsupported |
