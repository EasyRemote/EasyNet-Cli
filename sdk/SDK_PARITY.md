...
| Node/TypeScript | P1 | desktop tools and extensions | seam for Runtime Core, Health, Directory + Identity, Receipt, Publication, and Host Binding DTO/client lifecycle over injected transports; daemon providers and remaining profile clients unsupported |
