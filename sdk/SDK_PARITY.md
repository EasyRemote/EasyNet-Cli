...
| conformance runner | manifest partial | manifest partial | case-aware local facade actions partial | case-aware local facade actions partial | gap | gap | gap |
...
- Go and Python now consume shared SDK conformance cases and fixtures for
  selected local facade actions covering Runtime Core Invocation/health and Host
  Binding codec/hash behavior. Daemon-backed behavior-executing action adapters
  over the full case manifest remain incomplete.
