...
handle/prepare-submit seam partial. The package exposes typed feature/version
...
transport seams. Concrete daemon transport, profile clients, streams, bidi, and
