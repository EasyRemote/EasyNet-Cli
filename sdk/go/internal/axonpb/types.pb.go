...
const (
	...
	ResourceType_RESOURCE_TYPE_MISSION     ResourceType = 4 // EasyNet URA /r/<realm>/resource/<owner>/missions/<id>
...
//
//	FULL         — serves invocations and may also orchestrate missions.
//	ORCHESTRATOR — orchestrates missions only; hard-excluded from invocation
//	               target selection so the scheduler never dispatches abilities
//	               here. Use for K8s-style control-plane nodes.
//	WORKER       — serves invocations only; does not participate in mission
//	               orchestration. Use for edge devices that should never pull
//	               in the full mission-engine surface.
//
...
const (
	...
	RoutingStrategy_ROUTING_BROADCAST     RoutingStrategy = 3 // all matching nodes (mission fan-out)
)
...
const (
	...
	InvocationTargetKind_INVOCATION_TARGET_KIND_MCP_TOOL    InvocationTargetKind = 2 // MCP tool (resolves via package descriptor)
...
var (
	InvocationTargetKind_name = map[int32]string{
		...
		2: "INVOCATION_TARGET_KIND_MCP_TOOL",
	...
	InvocationTargetKind_value = map[string]int32{
		...
		"INVOCATION_TARGET_KIND_MCP_TOOL":    2,
...
// Mission lifecycle states retained for mission messages and Invoke-addressed
// mission abilities. RFC-001 removed the MissionControl gRPC service shell; do
// not reintroduce service-only runtime modules for these states.
type MissionState int32

const (
	MissionState_MISSION_STATE_UNSPECIFIED MissionState = 0
	MissionState_MISSION_STATE_PLANNED     MissionState = 1
	MissionState_MISSION_STATE_DISPATCHING MissionState = 2
	MissionState_MISSION_STATE_RUNNING     MissionState = 3
	MissionState_MISSION_STATE_PARTIAL     MissionState = 4 // some steps done, some failed
	MissionState_MISSION_STATE_COMPLETED   MissionState = 5
	MissionState_MISSION_STATE_ABORTED     MissionState = 6
	MissionState_MISSION_STATE_CANCELLED   MissionState = 7
	MissionState_MISSION_STATE_ROLLED_BACK MissionState = 8 // force-terminated, all steps cancelled (terminal)
)
...
var (
	MissionState_name = map[int32]string{
		...
		1: "MISSION_STATE_PLANNED",
		2: "MISSION_STATE_DISPATCHING",
		3: "MISSION_STATE_RUNNING",
		4: "MISSION_STATE_PARTIAL",
		5: "MISSION_STATE_COMPLETED",
		6: "MISSION_STATE_ABORTED",
		7: "MISSION_STATE_CANCELLED",
		8: "MISSION_STATE_ROLLED_BACK",
	}
	MissionState_value = map[string]int32{
		"MISSION_STATE_UNSPECIFIED": 0,
		"MISSION_STATE_PLANNED":     1,
		"MISSION_STATE_DISPATCHING": 2,
		"MISSION_STATE_RUNNING":     3,
		"MISSION_STATE_PARTIAL":     4,
		"MISSION_STATE_COMPLETED":   5,
		"MISSION_STATE_ABORTED":     6,
		"MISSION_STATE_CANCELLED":   7,
		"MISSION_STATE_ROLLED_BACK": 8,
	}
)
...
// Step lifecycle states for MissionControl step execution in `mission.proto`.
type MissionStepState int32

const (
	MissionStepState_MISSION_STEP_UNSPECIFIED MissionStepState = 0
	MissionStepState_MISSION_STEP_PENDING     MissionStepState = 1
	MissionStepState_MISSION_STEP_DISPATCHED  MissionStepState = 2
	MissionStepState_MISSION_STEP_RUNNING     MissionStepState = 3
	MissionStepState_MISSION_STEP_COMPLETED   MissionStepState = 4
	MissionStepState_MISSION_STEP_FAILED      MissionStepState = 5
	MissionStepState_MISSION_STEP_CANCELLED   MissionStepState = 6
	MissionStepState_MISSION_STEP_SKIPPED     MissionStepState = 7 // step failed, gracefully skipped per on_failure policy (not a failure)
)

// Enum value maps for MissionStepState.
var (
	MissionStepState_name = map[int32]string{
		0: "MISSION_STEP_UNSPECIFIED",
		1: "MISSION_STEP_PENDING",
		2: "MISSION_STEP_DISPATCHED",
		3: "MISSION_STEP_RUNNING",
		4: "MISSION_STEP_COMPLETED",
		5: "MISSION_STEP_FAILED",
		6: "MISSION_STEP_CANCELLED",
		7: "MISSION_STEP_SKIPPED",
	}
	MissionStepState_value = map[string]int32{
		"MISSION_STEP_UNSPECIFIED": 0,
		"MISSION_STEP_PENDING":     1,
		"MISSION_STEP_DISPATCHED":  2,
		"MISSION_STEP_RUNNING":     3,
		"MISSION_STEP_COMPLETED":   4,
		"MISSION_STEP_FAILED":      5,
		"MISSION_STEP_CANCELLED":   6,
		"MISSION_STEP_SKIPPED":     7,
	}
)

func (x MissionStepState) Enum() *MissionStepState {
	p := new(MissionStepState)
	*p = x
	return p
}

func (x MissionStepState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MissionStepState) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[18].Descriptor()
}

func (MissionStepState) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[18]
}

func (x MissionStepState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MissionStepState.Descriptor instead.
func (MissionStepState) EnumDescriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{18}
}

// Step-level failure policy — determines behavior when a step execution fails.
type StepFailurePolicy int32

const (
	StepFailurePolicy_STEP_FAILURE_POLICY_UNSPECIFIED   StepFailurePolicy = 0 // Default: treated as CONTINUE at runtime
	StepFailurePolicy_STEP_FAILURE_POLICY_ABORT_MISSION StepFailurePolicy = 1 // abort entire mission on step failure
	StepFailurePolicy_STEP_FAILURE_POLICY_SKIP          StepFailurePolicy = 2 // mark step Skipped, dependents still run
	StepFailurePolicy_STEP_FAILURE_POLICY_RETRY         StepFailurePolicy = 3 // retry step up to max_retries
	StepFailurePolicy_STEP_FAILURE_POLICY_CONTINUE      StepFailurePolicy = 4 // mark step Failed, dependents still run
)

// Enum value maps for StepFailurePolicy.
var (
	StepFailurePolicy_name = map[int32]string{
		0: "STEP_FAILURE_POLICY_UNSPECIFIED",
		1: "STEP_FAILURE_POLICY_ABORT_MISSION",
		2: "STEP_FAILURE_POLICY_SKIP",
		3: "STEP_FAILURE_POLICY_RETRY",
		4: "STEP_FAILURE_POLICY_CONTINUE",
	}
	StepFailurePolicy_value = map[string]int32{
		"STEP_FAILURE_POLICY_UNSPECIFIED":   0,
		"STEP_FAILURE_POLICY_ABORT_MISSION": 1,
		"STEP_FAILURE_POLICY_SKIP":          2,
		"STEP_FAILURE_POLICY_RETRY":         3,
		"STEP_FAILURE_POLICY_CONTINUE":      4,
	}
)

func (x StepFailurePolicy) Enum() *StepFailurePolicy {
	p := new(StepFailurePolicy)
	*p = x
	return p
}

func (x StepFailurePolicy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StepFailurePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[19].Descriptor()
}

func (StepFailurePolicy) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[19]
}

func (x StepFailurePolicy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StepFailurePolicy.Descriptor instead.
func (StepFailurePolicy) EnumDescriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{19}
}

// Timeline and event entry types for mission lifecycle observation.
// Used by TimelineEntry.entry_type and MissionEvent.event_type.
type TimelineEventType int32

const (
	TimelineEventType_TIMELINE_EVENT_UNSPECIFIED TimelineEventType = 0
	// Mission-level events (1-9). Value 9 is reserved for future mission-level events.
	TimelineEventType_TIMELINE_EVENT_MISSION_CREATED     TimelineEventType = 1
	TimelineEventType_TIMELINE_EVENT_MISSION_DISPATCHED  TimelineEventType = 2
	TimelineEventType_TIMELINE_EVENT_MISSION_CANCELLED   TimelineEventType = 3
	TimelineEventType_TIMELINE_EVENT_MISSION_ABORTED     TimelineEventType = 4
	TimelineEventType_TIMELINE_EVENT_MISSION_ROLLED_BACK TimelineEventType = 5
	TimelineEventType_TIMELINE_EVENT_MISSION_TERMINAL    TimelineEventType = 6
	TimelineEventType_TIMELINE_EVENT_MISSION_RUNNING     TimelineEventType = 7
	TimelineEventType_TIMELINE_EVENT_MISSION_RE_DISPATCH TimelineEventType = 8
	// Step-level events (10+)
	TimelineEventType_TIMELINE_EVENT_STEP_COMPLETED         TimelineEventType = 10
	TimelineEventType_TIMELINE_EVENT_STEP_FAILED            TimelineEventType = 11
	TimelineEventType_TIMELINE_EVENT_STEP_RETRIED           TimelineEventType = 12
	TimelineEventType_TIMELINE_EVENT_STEP_SKIPPED           TimelineEventType = 13
	TimelineEventType_TIMELINE_EVENT_STEP_RUNNING           TimelineEventType = 14
	TimelineEventType_TIMELINE_EVENT_STEP_AUTO_RETRY        TimelineEventType = 15
	TimelineEventType_TIMELINE_EVENT_STEP_RETRIES_EXHAUSTED TimelineEventType = 16
	TimelineEventType_TIMELINE_EVENT_STEP_PANICKED          TimelineEventType = 17
	// Granular step-invocation events (18+) for streaming observability.
	TimelineEventType_TIMELINE_EVENT_STEP_INVOCATION_ADMITTED  TimelineEventType = 18 // step invocation passed admission, about to execute
	TimelineEventType_TIMELINE_EVENT_STEP_INVOCATION_EXECUTING TimelineEventType = 19 // step invocation dispatched to execution layer
	TimelineEventType_TIMELINE_EVENT_STEP_RESULT_RECEIVED      TimelineEventType = 20 // step invocation result received from execution
)

// Enum value maps for TimelineEventType.
var (
	TimelineEventType_name = map[int32]string{
		0:  "TIMELINE_EVENT_UNSPECIFIED",
		1:  "TIMELINE_EVENT_MISSION_CREATED",
		2:  "TIMELINE_EVENT_MISSION_DISPATCHED",
		3:  "TIMELINE_EVENT_MISSION_CANCELLED",
		4:  "TIMELINE_EVENT_MISSION_ABORTED",
		5:  "TIMELINE_EVENT_MISSION_ROLLED_BACK",
		6:  "TIMELINE_EVENT_MISSION_TERMINAL",
		7:  "TIMELINE_EVENT_MISSION_RUNNING",
		8:  "TIMELINE_EVENT_MISSION_RE_DISPATCH",
		10: "TIMELINE_EVENT_STEP_COMPLETED",
		11: "TIMELINE_EVENT_STEP_FAILED",
		12: "TIMELINE_EVENT_STEP_RETRIED",
		13: "TIMELINE_EVENT_STEP_SKIPPED",
		14: "TIMELINE_EVENT_STEP_RUNNING",
		15: "TIMELINE_EVENT_STEP_AUTO_RETRY",
		16: "TIMELINE_EVENT_STEP_RETRIES_EXHAUSTED",
		17: "TIMELINE_EVENT_STEP_PANICKED",
		18: "TIMELINE_EVENT_STEP_INVOCATION_ADMITTED",
		19: "TIMELINE_EVENT_STEP_INVOCATION_EXECUTING",
		20: "TIMELINE_EVENT_STEP_RESULT_RECEIVED",
	}
	TimelineEventType_value = map[string]int32{
		"TIMELINE_EVENT_UNSPECIFIED":               0,
		"TIMELINE_EVENT_MISSION_CREATED":           1,
		"TIMELINE_EVENT_MISSION_DISPATCHED":        2,
		"TIMELINE_EVENT_MISSION_CANCELLED":         3,
		"TIMELINE_EVENT_MISSION_ABORTED":           4,
		"TIMELINE_EVENT_MISSION_ROLLED_BACK":       5,
		"TIMELINE_EVENT_MISSION_TERMINAL":          6,
		"TIMELINE_EVENT_MISSION_RUNNING":           7,
		"TIMELINE_EVENT_MISSION_RE_DISPATCH":       8,
		"TIMELINE_EVENT_STEP_COMPLETED":            10,
		"TIMELINE_EVENT_STEP_FAILED":               11,
		"TIMELINE_EVENT_STEP_RETRIED":              12,
		"TIMELINE_EVENT_STEP_SKIPPED":              13,
		"TIMELINE_EVENT_STEP_RUNNING":              14,
		"TIMELINE_EVENT_STEP_AUTO_RETRY":           15,
		"TIMELINE_EVENT_STEP_RETRIES_EXHAUSTED":    16,
		"TIMELINE_EVENT_STEP_PANICKED":             17,
		"TIMELINE_EVENT_STEP_INVOCATION_ADMITTED":  18,
		"TIMELINE_EVENT_STEP_INVOCATION_EXECUTING": 19,
		"TIMELINE_EVENT_STEP_RESULT_RECEIVED":      20,
	}
)
...
func (TimelineEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[20].Descriptor()
}

func (TimelineEventType) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[20]
}
...
func (KeyState) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[21].Descriptor()
}

func (KeyState) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[21]
}
...
// EasyNet execution hooks — default to passthrough/no-op.
type EasyNetHook int32

const (
	EasyNetHook_EASYNET_HOOK_UNSPECIFIED    EasyNetHook = 0
	EasyNetHook_EASYNET_HOOK_PLAN_RESOLVE   EasyNetHook = 1 // before mission execution: resolve plan graph
	EasyNetHook_EASYNET_HOOK_POOL_ALLOCATE  EasyNetHook = 2 // before scheduling: allocate from compute pool
	EasyNetHook_EASYNET_HOOK_ECONOMY_SETTLE EasyNetHook = 3 // after completion: settle credits
)

// Enum value maps for EasyNetHook.
var (
	EasyNetHook_name = map[int32]string{
		0: "EASYNET_HOOK_UNSPECIFIED",
		1: "EASYNET_HOOK_PLAN_RESOLVE",
		2: "EASYNET_HOOK_POOL_ALLOCATE",
		3: "EASYNET_HOOK_ECONOMY_SETTLE",
	}
	EasyNetHook_value = map[string]int32{
		"EASYNET_HOOK_UNSPECIFIED":    0,
		"EASYNET_HOOK_PLAN_RESOLVE":   1,
		"EASYNET_HOOK_POOL_ALLOCATE":  2,
		"EASYNET_HOOK_ECONOMY_SETTLE": 3,
	}
)

func (x EasyNetHook) Enum() *EasyNetHook {
	p := new(EasyNetHook)
	*p = x
	return p
}

func (x EasyNetHook) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EasyNetHook) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[22].Descriptor()
}

func (EasyNetHook) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[22]
}

func (x EasyNetHook) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EasyNetHook.Descriptor instead.
func (EasyNetHook) EnumDescriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{22}
}

type MCPToolCategory int32

const (
	MCPToolCategory_MCP_TOOL_CATEGORY_UNSPECIFIED    MCPToolCategory = 0
	MCPToolCategory_MCP_TOOL_CATEGORY_SESSION        MCPToolCategory = 1
	MCPToolCategory_MCP_TOOL_CATEGORY_FILESYSTEM     MCPToolCategory = 2
	MCPToolCategory_MCP_TOOL_CATEGORY_NETWORK        MCPToolCategory = 3
	MCPToolCategory_MCP_TOOL_CATEGORY_SYSTEM         MCPToolCategory = 4
	MCPToolCategory_MCP_TOOL_CATEGORY_AI             MCPToolCategory = 5
	MCPToolCategory_MCP_TOOL_CATEGORY_SENSOR         MCPToolCategory = 6
	MCPToolCategory_MCP_TOOL_CATEGORY_MEDIA          MCPToolCategory = 7
	MCPToolCategory_MCP_TOOL_CATEGORY_REMOTE_CONTROL MCPToolCategory = 8
	MCPToolCategory_MCP_TOOL_CATEGORY_DISCOVERY      MCPToolCategory = 9
	MCPToolCategory_MCP_TOOL_CATEGORY_INTEGRATION    MCPToolCategory = 10
	MCPToolCategory_MCP_TOOL_CATEGORY_OTHER          MCPToolCategory = 11
)

// Enum value maps for MCPToolCategory.
var (
	MCPToolCategory_name = map[int32]string{
		0:  "MCP_TOOL_CATEGORY_UNSPECIFIED",
		1:  "MCP_TOOL_CATEGORY_SESSION",
		2:  "MCP_TOOL_CATEGORY_FILESYSTEM",
		3:  "MCP_TOOL_CATEGORY_NETWORK",
		4:  "MCP_TOOL_CATEGORY_SYSTEM",
		5:  "MCP_TOOL_CATEGORY_AI",
		6:  "MCP_TOOL_CATEGORY_SENSOR",
		7:  "MCP_TOOL_CATEGORY_MEDIA",
		8:  "MCP_TOOL_CATEGORY_REMOTE_CONTROL",
		9:  "MCP_TOOL_CATEGORY_DISCOVERY",
		10: "MCP_TOOL_CATEGORY_INTEGRATION",
		11: "MCP_TOOL_CATEGORY_OTHER",
	}
	MCPToolCategory_value = map[string]int32{
		"MCP_TOOL_CATEGORY_UNSPECIFIED":    0,
		"MCP_TOOL_CATEGORY_SESSION":        1,
		"MCP_TOOL_CATEGORY_FILESYSTEM":     2,
		"MCP_TOOL_CATEGORY_NETWORK":        3,
		"MCP_TOOL_CATEGORY_SYSTEM":         4,
		"MCP_TOOL_CATEGORY_AI":             5,
		"MCP_TOOL_CATEGORY_SENSOR":         6,
		"MCP_TOOL_CATEGORY_MEDIA":          7,
		"MCP_TOOL_CATEGORY_REMOTE_CONTROL": 8,
		"MCP_TOOL_CATEGORY_DISCOVERY":      9,
		"MCP_TOOL_CATEGORY_INTEGRATION":    10,
		"MCP_TOOL_CATEGORY_OTHER":          11,
	}
)

func (x MCPToolCategory) Enum() *MCPToolCategory {
	p := new(MCPToolCategory)
	*p = x
	return p
}

func (x MCPToolCategory) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MCPToolCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_axon_v1_types_proto_enumTypes[23].Descriptor()
}

func (MCPToolCategory) Type() protoreflect.EnumType {
	return &file_axon_v1_types_proto_enumTypes[23]
}

func (x MCPToolCategory) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MCPToolCategory.Descriptor instead.
func (MCPToolCategory) EnumDescriptor() ([]byte, []int) {
...
type ResourceRef struct {
	...
	SubId         string                 `protobuf:"bytes,3,opt,name=sub_id,json=subId,proto3" json:"sub_id,omitempty"`                // optional: step_id, rule_id, key_version, etc.
...
// Proto mirror of the JSON DelegationProof verified at the admission
// gate (core/runtime-rs/.../delegation_gate.rs). Field names/order
// mirror DelegationPayload so re-marshal is byte-identical to the Go
// signer (EasyNet/backend/internal/axon/delegation.go). The signature
// is over the canonical JSON of the payload fields, NOT over the proto.
...
type Envelope struct {
	...
	Easynet        *EasyNetContext `protobuf:"bytes,11,opt,name=easynet,proto3" json:"easynet,omitempty"`
...
func (x *Envelope) GetEasynet() *EasyNetContext {
	if x != nil {
		return x.Easynet
	}
	return nil
...
type CapabilityDescriptor struct {
	...
	McpTools          []*MCPToolSpec         `protobuf:"bytes,11,rep,name=mcp_tools,json=mcpTools,proto3" json:"mcp_tools,omitempty"` // explicit MCP exposures derived from mcp.* metadata
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CapabilityDescriptor) GetMcpTools() []*MCPToolSpec {
	if x != nil {
		return x.McpTools
	}
	return nil
...
func (x *McpToolTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*McpToolTarget) ProtoMessage() {}

func (x *McpToolTarget) ProtoReflect() protoreflect.Message {
	mi := &file_axon_v1_types_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use McpToolTarget.ProtoReflect.Descriptor instead.
func (*McpToolTarget) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{49}
}

func (x *McpToolTarget) GetToolName() string {
	if x != nil {
		return x.ToolName
	}
	return ""
...
func (x *InvocationTarget) GetMcpTool() *McpToolTarget {
	if x != nil {
		if x, ok := x.TypedTarget.(*InvocationTarget_McpTool); ok {
			return x.McpTool
		}
	}
	return nil
...
type InvocationTarget_McpTool struct {
	McpTool *McpToolTarget `protobuf:"bytes,11,opt,name=mcp_tool,json=mcpTool,proto3,oneof"`
}
...
func (*InvocationTarget_McpTool) isInvocationTarget_TypedTarget() {}
...
type ObjectiveWeights struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Latency       float64                `protobuf:"fixed64,1,opt,name=latency,proto3" json:"latency,omitempty"` // 0.0-1.0 weight for latency optimization
	Cost          float64                `protobuf:"fixed64,2,opt,name=cost,proto3" json:"cost,omitempty"`       // 0.0-1.0 weight for cost minimization
	Quality       float64                `protobuf:"fixed64,3,opt,name=quality,proto3" json:"quality,omitempty"` // 0.0-1.0 weight for result quality
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ObjectiveWeights) Reset() {
	*x = ObjectiveWeights{}
...
func (x *ObjectiveWeights) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjectiveWeights) ProtoMessage() {}

func (x *ObjectiveWeights) ProtoReflect() protoreflect.Message {
	mi := &file_axon_v1_types_proto_msgTypes[56]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObjectiveWeights.ProtoReflect.Descriptor instead.
func (*ObjectiveWeights) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{56}
}

func (x *ObjectiveWeights) GetLatency() float64 {
	if x != nil {
		return x.Latency
	}
	return 0
...
func (x *ObjectiveWeights) GetCost() float64 {
	if x != nil {
		return x.Cost
	}
	return 0
...
func (x *ObjectiveWeights) GetQuality() float64 {
	if x != nil {
		return x.Quality
	}
	return 0
...
type EasyNetContext struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	IntentId           string                 `protobuf:"bytes,1,opt,name=intent_id,json=intentId,proto3" json:"intent_id,omitempty"`                                              // future: intent that triggered this operation
	PlanGraphRef       string                 `protobuf:"bytes,2,opt,name=plan_graph_ref,json=planGraphRef,proto3" json:"plan_graph_ref,omitempty"`                                // future: EasyNet URA /r/<realm>/resource/<owner>/plans/<plan_id>
	Objectives         *ObjectiveWeights      `protobuf:"bytes,3,opt,name=objectives,proto3" json:"objectives,omitempty"`                                                          // future: multi-objective weights
	BudgetLimit        float64                `protobuf:"fixed64,4,opt,name=budget_limit,json=budgetLimit,proto3" json:"budget_limit,omitempty"`                                   // future: max credit spend for this operation
	ReputationMinScore float64                `protobuf:"fixed64,5,opt,name=reputation_min_score,json=reputationMinScore,proto3" json:"reputation_min_score,omitempty"`            // future: minimum reputation score for node selection
	EnabledHooks       []EasyNetHook          `protobuf:"varint,6,rep,packed,name=enabled_hooks,json=enabledHooks,proto3,enum=axon.v1.EasyNetHook" json:"enabled_hooks,omitempty"` // which hooks are active (empty = all passthrough)
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *EasyNetContext) Reset() {
	*x = EasyNetContext{}
	mi := &file_axon_v1_types_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EasyNetContext) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EasyNetContext) ProtoMessage() {}

func (x *EasyNetContext) ProtoReflect() protoreflect.Message {
	mi := &file_axon_v1_types_proto_msgTypes[57]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EasyNetContext.ProtoReflect.Descriptor instead.
func (*EasyNetContext) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{57}
}

func (x *EasyNetContext) GetIntentId() string {
	if x != nil {
		return x.IntentId
	}
	return ""
...
func (x *EasyNetContext) GetPlanGraphRef() string {
	if x != nil {
		return x.PlanGraphRef
	}
	return ""
}

func (x *EasyNetContext) GetObjectives() *ObjectiveWeights {
	if x != nil {
		return x.Objectives
	}
	return nil
...
func (x *EasyNetContext) GetBudgetLimit() float64 {
	if x != nil {
...
func (x *EasyNetContext) GetReputationMinScore() float64 {
	if x != nil {
		return x.ReputationMinScore
	}
	return 0
}

func (x *EasyNetContext) GetEnabledHooks() []EasyNetHook {
	if x != nil {
...
// Lightweight MCP discovery contract used by ListMCPTools and other
// advertise-only flows. Field numbers mirror the MCPToolSpec Tier 1 subset
// where practical so summary/full-spec comparisons do not need field remapping;
// field 4 (`output_schema`) is intentionally excluded at this tier.
type MCPToolSpecSummary struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	ToolName        string                 `protobuf:"bytes,1,opt,name=tool_name,json=toolName,proto3" json:"tool_name,omitempty"`
	...
	IdempotentHint  bool                   `protobuf:"varint,7,opt,name=idempotent_hint,json=idempotentHint,proto3" json:"idempotent_hint,omitempty"`
	OpenWorldHint   bool                   `protobuf:"varint,8,opt,name=open_world_hint,json=openWorldHint,proto3" json:"open_world_hint,omitempty"`
	Category        string                 `protobuf:"bytes,13,opt,name=category,proto3" json:"category,omitempty"`
	// Keep the typed category slot aligned with MCPToolSpec.category_kind = 20
	// so summary/full-spec comparisons do not need per-field remapping.
	CategoryKind  MCPToolCategory `protobuf:"varint,20,opt,name=category_kind,json=categoryKind,proto3,enum=axon.v1.MCPToolCategory" json:"category_kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MCPToolSpecSummary) Reset() {
	*x = MCPToolSpecSummary{}
	mi := &file_axon_v1_types_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MCPToolSpecSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MCPToolSpecSummary) ProtoMessage() {}

func (x *MCPToolSpecSummary) ProtoReflect() protoreflect.Message {
	mi := &file_axon_v1_types_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MCPToolSpecSummary.ProtoReflect.Descriptor instead.
func (*MCPToolSpecSummary) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{58}
}

func (x *MCPToolSpecSummary) GetToolName() string {
	if x != nil {
		return x.ToolName
	}
	return ""
...
func (x *MCPToolSpecSummary) GetDescription() string {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetInputSchema() []byte {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetReadOnlyHint() bool {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetDestructiveHint() bool {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetIdempotentHint() bool {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetOpenWorldHint() bool {
	if x != nil {
...
func (x *MCPToolSpecSummary) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *MCPToolSpecSummary) GetCategoryKind() MCPToolCategory {
	if x != nil {
		return x.CategoryKind
	}
	return MCPToolCategory_MCP_TOOL_CATEGORY_UNSPECIFIED
}

type MCPToolSpec struct {
	state        protoimpl.MessageState `protogen:"open.v1"`
	ToolName     string                 `protobuf:"bytes,1,opt,name=tool_name,json=toolName,proto3" json:"tool_name,omitempty"`             // MCP tool name, e.g. "read_file", "search_web"
	Description  string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`                       // human-readable description for LLM tool selection
	InputSchema  []byte                 `protobuf:"bytes,3,opt,name=input_schema,json=inputSchema,proto3" json:"input_schema,omitempty"`    // JSON Schema defining expected input
	OutputSchema []byte                 `protobuf:"bytes,4,opt,name=output_schema,json=outputSchema,proto3" json:"output_schema,omitempty"` // JSON Schema defining output format
	// MCP annotations (hints for LLM/client behavior)
	ReadOnlyHint    bool `protobuf:"varint,5,opt,name=read_only_hint,json=readOnlyHint,proto3" json:"read_only_hint,omitempty"`        // tool does not modify state
	DestructiveHint bool `protobuf:"varint,6,opt,name=destructive_hint,json=destructiveHint,proto3" json:"destructive_hint,omitempty"` // tool may cause irreversible changes
	IdempotentHint  bool `protobuf:"varint,7,opt,name=idempotent_hint,json=idempotentHint,proto3" json:"idempotent_hint,omitempty"`    // repeated calls with same input produce same result
	OpenWorldHint   bool `protobuf:"varint,8,opt,name=open_world_hint,json=openWorldHint,proto3" json:"open_world_hint,omitempty"`     // tool interacts with external entities
	// Full operational instructions for the AI agent — the SKILL.md equivalent.
	// Should explain: what the tool does, when to use it, step-by-step usage,
	// error handling, and interaction with related tools. <5000 tokens.
	Instructions string `protobuf:"bytes,9,opt,name=instructions,proto3" json:"instructions,omitempty"`
	// Example input objects, each a JSON document conforming to input_schema.
	// Helps agents understand expected invocation patterns for complex tools.
	// Aligns with Anthropic API's input_examples field.
	InputExamples []string `protobuf:"bytes,10,rep,name=input_examples,json=inputExamples,proto3" json:"input_examples,omitempty"`
	// Human-readable prerequisites needed before calling this tool.
	// E.g., ["Must call session_start first to obtain a session_id",
	//
	//	"Requires node to have Python 3.10+"].
	Prerequisites []string `protobuf:"bytes,11,rep,name=prerequisites,proto3" json:"prerequisites,omitempty"`
	// Context bindings: key-value declarations of what this ability accesses.
	// Encodes the context_binding dimension of Ability = (code, state, context_binding).
	// Keys follow dotted namespace convention:
	//
	//	"env.PYTHON_PATH", "resource.camera", "data.user_preferences",
	//	"requires.runtime_version", "output.format".
	ContextBindings map[string]string `protobuf:"bytes,12,rep,name=context_bindings,json=contextBindings,proto3" json:"context_bindings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Tool category for grouping in discovery UIs and agent tool selection.
	// E.g., "session", "filesystem", "network", "system", "ai", "sensor".
	Category string `protobuf:"bytes,13,opt,name=category,proto3" json:"category,omitempty"`
	// Structured category for SDKs/UIs that need typed grouping without parsing
	// free-form strings. Producers should set both `category` and
	// `category_kind`; when they differ, `category_kind` is authoritative for
	// machine decisions and `category` is display-only metadata. Unknown strings
	// should map to OTHER.
	CategoryKind  MCPToolCategory `protobuf:"varint,20,opt,name=category_kind,json=categoryKind,proto3,enum=axon.v1.MCPToolCategory" json:"category_kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MCPToolSpec) Reset() {
	*x = MCPToolSpec{}
	mi := &file_axon_v1_types_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MCPToolSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MCPToolSpec) ProtoMessage() {}

func (x *MCPToolSpec) ProtoReflect() protoreflect.Message {
	mi := &file_axon_v1_types_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MCPToolSpec.ProtoReflect.Descriptor instead.
func (*MCPToolSpec) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{59}
}

func (x *MCPToolSpec) GetToolName() string {
	if x != nil {
		return x.ToolName
	}
	return ""
...
func (x *MCPToolSpec) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *MCPToolSpec) GetInputSchema() []byte {
	if x != nil {
		return x.InputSchema
	}
	return nil
...
func (x *MCPToolSpec) GetOutputSchema() []byte {
	if x != nil {
...
func (x *MCPToolSpec) GetReadOnlyHint() bool {
	if x != nil {
		return x.ReadOnlyHint
	}
	return false
...
func (x *MCPToolSpec) GetDestructiveHint() bool {
	if x != nil {
		return x.DestructiveHint
	}
	return false
...
func (x *MCPToolSpec) GetIdempotentHint() bool {
	if x != nil {
		return x.IdempotentHint
	}
	return false
...
func (x *MCPToolSpec) GetOpenWorldHint() bool {
	if x != nil {
		return x.OpenWorldHint
	}
	return false
...
func (x *MCPToolSpec) GetInstructions() string {
	if x != nil {
...
func (x *MCPToolSpec) GetInputExamples() []string {
	if x != nil {
		return x.InputExamples
	}
	return nil
}

func (x *MCPToolSpec) GetPrerequisites() []string {
	if x != nil {
...
func (x *MCPToolSpec) GetContextBindings() map[string]string {
	if x != nil {
		return x.ContextBindings
	}
	return nil
}

func (x *MCPToolSpec) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *MCPToolSpec) GetCategoryKind() MCPToolCategory {
	if x != nil {
		return x.CategoryKind
	}
	return MCPToolCategory_MCP_TOOL_CATEGORY_UNSPECIFIED
...
func (x *A2ASkillSpec) Reset() {
	*x = A2ASkillSpec{}
	mi := &file_axon_v1_types_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*A2ASkillSpec) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{60}
}
...
func (x *A2AAgentCard) Reset() {
	*x = A2AAgentCard{}
	mi := &file_axon_v1_types_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*A2AAgentCard) Descriptor() ([]byte, []int) {
	return file_axon_v1_types_proto_rawDescGZIP(), []int{61}
}
...
const file_axon_v1_types_proto_rawDesc = "" +
	...
	"\aability\x18\x03 \x01(\tR\aability\"\xf8\x05\n" +
	"\bEnvelope\x12\x1d\n" +
	"\n" +
	...
	"\bpriority\x18\n" +
	" \x01(\x0e2\x11.axon.v1.PriorityR\bpriority\x121\n" +
	"\aeasynet\x18\v \x01(\v2\x17.axon.v1.EasyNetContextR\aeasynet\x12.\n" +
	...
	"\x10caller_signature\x18\x19 \x01(\v2\x18.axon.v1.CallerSignatureR\x0fcallerSignatureJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\f\x10\rJ\x04\b\x1a\x10\x1bJ\x04\b\x1b\x10\x1cR\ttenant_idR\bagent_idR\fprincipal_idR\x14parent_invocation_idR\vsubject_refR\x12descriptor_version\"\x80\x01\n" +
	...
	"\x06digest\x18\x03 \x01(\tR\x06digest\"\xec\x03\n" +
	...
	"\ta2a_skill\x18\n" +
	" \x01(\v2\x15.axon.v1.A2ASkillSpecR\ba2aSkill\x121\n" +
	"\tmcp_tools\x18\v \x03(\v2\x14.axon.v1.MCPToolSpecR\bmcpTools\x1a?\n" +
	...
	"\rMcpToolTarget\x12\x1b\n" +
	"\ttool_name\x18\x01 \x01(\tR\btoolName\"S\n" +
	"\x0eA2aSkillTarget\x12&\n" +
	"\x0ftarget_agent_id\x18\x01 \x01(\tR\rtargetAgentId\x12\x19\n" +
	"\bskill_id\x18\x02 \x01(\tR\askillId\"\xbc\x03\n" +
	...
	"\aability\x18\n" +
	" \x01(\v2\x16.axon.v1.AbilityTargetH\x00R\aability\x123\n" +
	"\bmcp_tool\x18\v \x01(\v2\x16.axon.v1.McpToolTargetH\x00R\amcpTool\x126\n" +
	"\ta2a_skill\x18\f \x01(\v2\x17.axon.v1.A2aSkillTargetH\x00R\ba2aSkillB\x0e\n" +
	"\ftyped_target\"\x8c\x02\n" +
	"\aKeyInfo\x12\x19\n" +
	...
	"\x10ObjectiveWeights\x12\x18\n" +
	"\alatency\x18\x01 \x01(\x01R\alatency\x12\x12\n" +
	"\x04cost\x18\x02 \x01(\x01R\x04cost\x12\x18\n" +
	"\aquality\x18\x03 \x01(\x01R\aquality\"\x9e\x02\n" +
	"\x0eEasyNetContext\x12\x1b\n" +
	"\tintent_id\x18\x01 \x01(\tR\bintentId\x12$\n" +
	"\x0eplan_graph_ref\x18\x02 \x01(\tR\fplanGraphRef\x129\n" +
	"\n" +
	"objectives\x18\x03 \x01(\v2\x19.axon.v1.ObjectiveWeightsR\n" +
	"objectives\x12!\n" +
	"\fbudget_limit\x18\x04 \x01(\x01R\vbudgetLimit\x120\n" +
	"\x14reputation_min_score\x18\x05 \x01(\x01R\x12reputationMinScore\x129\n" +
	"\renabled_hooks\x18\x06 \x03(\x0e2\x14.axon.v1.EasyNetHookR\fenabledHooks\"\x85\x03\n" +
	"\x12MCPToolSpecSummary\x12\x1b\n" +
	"\ttool_name\x18\x01 \x01(\tR\btoolName\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12!\n" +
	"\finput_schema\x18\x03 \x01(\fR\vinputSchema\x12$\n" +
	"\x0eread_only_hint\x18\x05 \x01(\bR\freadOnlyHint\x12)\n" +
	"\x10destructive_hint\x18\x06 \x01(\bR\x0fdestructiveHint\x12'\n" +
	"\x0fidempotent_hint\x18\a \x01(\bR\x0eidempotentHint\x12&\n" +
	"\x0fopen_world_hint\x18\b \x01(\bR\ropenWorldHint\x12\x1a\n" +
	"\bcategory\x18\r \x01(\tR\bcategory\x12=\n" +
	"\rcategory_kind\x18\x14 \x01(\x0e2\x18.axon.v1.MCPToolCategoryR\fcategoryKindJ\x04\b\x04\x10\x05J\x04\b\t\x10\rJ\x04\b\x0e\x10\x14\"\xa2\x05\n" +
	"\vMCPToolSpec\x12\x1b\n" +
	"\ttool_name\x18\x01 \x01(\tR\btoolName\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12!\n" +
	"\finput_schema\x18\x03 \x01(\fR\vinputSchema\x12#\n" +
	...
	"\x10destructive_hint\x18\x06 \x01(\bR\x0fdestructiveHint\x12'\n" +
	"\x0fidempotent_hint\x18\a \x01(\bR\x0eidempotentHint\x12&\n" +
	"\x0fopen_world_hint\x18\b \x01(\bR\ropenWorldHint\x12\"\n" +
	"\finstructions\x18\t \x01(\tR\finstructions\x12%\n" +
	"\x0einput_examples\x18\n" +
	" \x03(\tR\rinputExamples\x12$\n" +
	"\rprerequisites\x18\v \x03(\tR\rprerequisites\x12T\n" +
	"\x10context_bindings\x18\f \x03(\v2).axon.v1.MCPToolSpec.ContextBindingsEntryR\x0fcontextBindings\x12\x1a\n" +
	"\bcategory\x18\r \x01(\tR\bcategory\x12=\n" +
	"\rcategory_kind\x18\x14 \x01(\x0e2\x18.axon.v1.MCPToolCategoryR\fcategoryKind\x1aB\n" +
	"\x14ContextBindingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x0e\x10\x14\"\xd7\x01\n" +
	...
	"\x11RESOURCE_TYPE_KEY\x10\b*\xe0\x01\n" +
	...
	"\x17MISSION_STATE_CANCELLED\x10\a\x12\x1d\n" +
	"\x19MISSION_STATE_ROLLED_BACK\x10\b*\xec\x01\n" +
	...
	"\x14MISSION_STEP_SKIPPED\x10\a*\xbe\x01\n" +
	...
	"\x1eTIMELINE_EVENT_MISSION_RUNNING\x10\a\x12&\n" +
	"\"TIMELINE_EVENT_MISSION_RE_DISPATCH\x10\b\x12!\n" +
	"\x1dTIMELINE_EVENT_STEP_COMPLETED\x10\n" +
	"\x12\x1e\n" +
	"\x1aTIMELINE_EVENT_STEP_FAILED\x10\v\x12\x1f\n" +
	"\x1bTIMELINE_EVENT_STEP_RETRIED\x10\f\x12\x1f\n" +
	...
	"\vEasyNetHook\x12\x1c\n" +
	"\x18EASYNET_HOOK_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19EASYNET_HOOK_PLAN_RESOLVE\x10\x01\x12\x1e\n" +
	"\x1aEASYNET_HOOK_POOL_ALLOCATE\x10\x02\x12\x1f\n" +
	"\x1bEASYNET_HOOK_ECONOMY_SETTLE\x10\x03*\x8e\x03\n" +
	...
	"\x17MCP_TOOL_CATEGORY_MEDIA\x10\a\x12$\n" +
	" MCP_TOOL_CATEGORY_REMOTE_CONTROL\x10\b\x12\x1f\n" +
	"\x1bMCP_TOOL_CATEGORY_DISCOVERY\x10\t\x12!\n" +
	"\x1dMCP_TOOL_CATEGORY_INTEGRATION\x10\n" +
	"\x12\x1b\n" +
	"\x17MCP_TOOL_CATEGORY_OTHER\x10\vb\x06proto3"
...
var file_axon_v1_types_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_axon_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
var file_axon_v1_types_proto_goTypes = []any{
	...
	(MissionState)(0),                         // 17: axon.v1.MissionState
	(MissionStepState)(0),                     // 18: axon.v1.MissionStepState
	(StepFailurePolicy)(0),                    // 19: axon.v1.StepFailurePolicy
	(TimelineEventType)(0),                    // 20: axon.v1.TimelineEventType
	(KeyState)(0),                             // 21: axon.v1.KeyState
	(EasyNetHook)(0),                          // 22: axon.v1.EasyNetHook
	(MCPToolCategory)(0),                      // 23: axon.v1.MCPToolCategory
	(*ResourceRef)(nil),                       // 24: axon.v1.ResourceRef
	(*BackpressureSignal)(nil),                // 25: axon.v1.BackpressureSignal
	(*CircuitBreakerConfig)(nil),              // 26: axon.v1.CircuitBreakerConfig
	(*CircuitBreakerStatus)(nil),              // 27: axon.v1.CircuitBreakerStatus
	(*RateLimitInfo)(nil),                     // 28: axon.v1.RateLimitInfo
	(*SchedulingScore)(nil),                   // 29: axon.v1.SchedulingScore
	(*ContentEnvelope)(nil),                   // 30: axon.v1.ContentEnvelope
	(*ChannelSecurity)(nil),                   // 31: axon.v1.ChannelSecurity
	(*EncryptedPayload)(nil),                  // 32: axon.v1.EncryptedPayload
	(*AgentIdentity)(nil),                     // 33: axon.v1.AgentIdentity
	(*SubjectIdentity)(nil),                   // 34: axon.v1.SubjectIdentity
	(*EntityRef)(nil),                         // 35: axon.v1.EntityRef
	(*InvocationAuthorityProof)(nil),          // 36: axon.v1.InvocationAuthorityProof
	(*CausalContext)(nil),                     // 37: axon.v1.CausalContext
	(*Empty)(nil),                             // 38: axon.v1.Empty
	(*ReceiptRef)(nil),                        // 39: axon.v1.ReceiptRef
	(*ReceiptList)(nil),                       // 40: axon.v1.ReceiptList
	(*MerkleRoot)(nil),                        // 41: axon.v1.MerkleRoot
	(*CallerSignature)(nil),                   // 42: axon.v1.CallerSignature
	(*CalleeSignature)(nil),                   // 43: axon.v1.CalleeSignature
	(*AuthorityBinding)(nil),                  // 44: axon.v1.AuthorityBinding
	(*SelfAuthority)(nil),                     // 45: axon.v1.SelfAuthority
	(*DelegationProof)(nil),                   // 46: axon.v1.DelegationProof
	(*CapabilityGrant)(nil),                   // 47: axon.v1.CapabilityGrant
	(*PolicyGrant)(nil),                       // 48: axon.v1.PolicyGrant
	(*SessionAuthority)(nil),                  // 49: axon.v1.SessionAuthority
	(*BootstrapAuthority)(nil),                // 50: axon.v1.BootstrapAuthority
	(*Envelope)(nil),                          // 51: axon.v1.Envelope
	(*ResponseHeader)(nil),                    // 52: axon.v1.ResponseHeader
	(*Error)(nil),                             // 53: axon.v1.Error
	(*SealedLedgerEventPayload)(nil),          // 54: axon.v1.SealedLedgerEventPayload
	(*LedgerEventPayload)(nil),                // 55: axon.v1.LedgerEventPayload
	(*RecipientSealedLedgerEventPayload)(nil), // 56: axon.v1.RecipientSealedLedgerEventPayload
	(*LedgerPayloadVisibility)(nil),           // 57: axon.v1.LedgerPayloadVisibility
	(*LedgerVisibilitySummary)(nil),           // 58: axon.v1.LedgerVisibilitySummary
	(*LedgerErrorRecord)(nil),                 // 59: axon.v1.LedgerErrorRecord
	(*LedgerDiagnosticRecord)(nil),            // 60: axon.v1.LedgerDiagnosticRecord
	(*InvocationReceiptAnchor)(nil),           // 61: axon.v1.InvocationReceiptAnchor
	(*InvocationReceiptChainSummary)(nil),     // 62: axon.v1.InvocationReceiptChainSummary
	(*InvocationCausalLink)(nil),              // 63: axon.v1.InvocationCausalLink
	(*InvocationTraceEdge)(nil),               // 64: axon.v1.InvocationTraceEdge
	(*InvocationTraceGraph)(nil),              // 65: axon.v1.InvocationTraceGraph
	(*InvocationLedgerRecord)(nil),            // 66: axon.v1.InvocationLedgerRecord
	(*ResourceSnapshot)(nil),                  // 67: axon.v1.ResourceSnapshot
	(*DeviceMeta)(nil),                        // 68: axon.v1.DeviceMeta
	(*NodeDescriptor)(nil),                    // 69: axon.v1.NodeDescriptor
	(*CapabilityPackageRef)(nil),              // 70: axon.v1.CapabilityPackageRef
	(*CapabilityDescriptor)(nil),              // 71: axon.v1.CapabilityDescriptor
	(*AbilityTarget)(nil),                     // 72: axon.v1.AbilityTarget
	(*McpToolTarget)(nil),                     // 73: axon.v1.McpToolTarget
	(*A2ASkillTarget)(nil),                    // 74: axon.v1.A2aSkillTarget
	(*InvocationTarget)(nil),                  // 75: axon.v1.InvocationTarget
	(*KeyInfo)(nil),                           // 76: axon.v1.KeyInfo
	(*AuditEntry)(nil),                        // 77: axon.v1.AuditEntry
	(*ContentMeta)(nil),                       // 78: axon.v1.ContentMeta
	(*PayloadRef)(nil),                        // 79: axon.v1.PayloadRef
	(*ObjectiveWeights)(nil),                  // 80: axon.v1.ObjectiveWeights
	(*EasyNetContext)(nil),                    // 81: axon.v1.EasyNetContext
	(*MCPToolSpecSummary)(nil),                // 82: axon.v1.MCPToolSpecSummary
	(*MCPToolSpec)(nil),                       // 83: axon.v1.MCPToolSpec
	(*A2ASkillSpec)(nil),                      // 84: axon.v1.A2ASkillSpec
	(*A2AAgentCard)(nil),                      // 85: axon.v1.A2AAgentCard
	nil,                                       // 86: axon.v1.Error.ContextEntry
	nil,                                       // 87: axon.v1.LedgerErrorRecord.ContextEntry
	nil,                                       // 88: axon.v1.NodeDescriptor.LabelsEntry
	nil,                                       // 89: axon.v1.CapabilityDescriptor.RequirementsEntry
	nil,                                       // 90: axon.v1.PayloadRef.LabelsEntry
	nil,                                       // 91: axon.v1.MCPToolSpec.ContextBindingsEntry
	nil,                                       // 92: axon.v1.A2AAgentCard.AuthenticationEntry
}
var file_axon_v1_types_proto_depIdxs = []int32{
	...
	78, // 2: axon.v1.ContentEnvelope.meta:type_name -> axon.v1.ContentMeta
	...
	44, // 6: axon.v1.InvocationAuthorityProof.binding:type_name -> axon.v1.AuthorityBinding
	33, // 7: axon.v1.InvocationAuthorityProof.issuer:type_name -> axon.v1.AgentIdentity
	43, // 8: axon.v1.InvocationAuthorityProof.signature:type_name -> axon.v1.CalleeSignature
	38, // 9: axon.v1.CausalContext.none:type_name -> axon.v1.Empty
	39, // 10: axon.v1.CausalContext.scalar:type_name -> axon.v1.ReceiptRef
	40, // 11: axon.v1.CausalContext.list:type_name -> axon.v1.ReceiptList
	41, // 12: axon.v1.CausalContext.merkle:type_name -> axon.v1.MerkleRoot
	39, // 13: axon.v1.ReceiptList.prior:type_name -> axon.v1.ReceiptRef
	45, // 14: axon.v1.AuthorityBinding.self_authority:type_name -> axon.v1.SelfAuthority
	46, // 15: axon.v1.AuthorityBinding.delegated_authority:type_name -> axon.v1.DelegationProof
	47, // 16: axon.v1.AuthorityBinding.capability_grant:type_name -> axon.v1.CapabilityGrant
	48, // 17: axon.v1.AuthorityBinding.policy_grant:type_name -> axon.v1.PolicyGrant
	49, // 18: axon.v1.AuthorityBinding.session_authority:type_name -> axon.v1.SessionAuthority
	50, // 19: axon.v1.AuthorityBinding.bootstrap_authority:type_name -> axon.v1.BootstrapAuthority
	2,  // 20: axon.v1.Envelope.priority:type_name -> axon.v1.Priority
	81, // 21: axon.v1.Envelope.easynet:type_name -> axon.v1.EasyNetContext
	33, // 22: axon.v1.Envelope.caller:type_name -> axon.v1.AgentIdentity
	33, // 23: axon.v1.Envelope.callee:type_name -> axon.v1.AgentIdentity
	34, // 24: axon.v1.Envelope.subject:type_name -> axon.v1.SubjectIdentity
	37, // 25: axon.v1.Envelope.causal_context:type_name -> axon.v1.CausalContext
	42, // 26: axon.v1.Envelope.caller_signature:type_name -> axon.v1.CallerSignature
	86, // 27: axon.v1.Error.context:type_name -> axon.v1.Error.ContextEntry
	6,  // 28: axon.v1.Error.stage:type_name -> axon.v1.ErrorStage
	7,  // 29: axon.v1.Error.security_class:type_name -> axon.v1.SecurityClass
	8,  // 30: axon.v1.LedgerEventPayload.kind:type_name -> axon.v1.LedgerEventPayloadKind
	54, // 31: axon.v1.LedgerEventPayload.sealed:type_name -> axon.v1.SealedLedgerEventPayload
	56, // 32: axon.v1.LedgerEventPayload.recipients:type_name -> axon.v1.RecipientSealedLedgerEventPayload
	54, // 33: axon.v1.RecipientSealedLedgerEventPayload.payload:type_name -> axon.v1.SealedLedgerEventPayload
	57, // 34: axon.v1.LedgerVisibilitySummary.args:type_name -> axon.v1.LedgerPayloadVisibility
	57, // 35: axon.v1.LedgerVisibilitySummary.result:type_name -> axon.v1.LedgerPayloadVisibility
	57, // 36: axon.v1.LedgerVisibilitySummary.diagnostics:type_name -> axon.v1.LedgerPayloadVisibility
	87, // 37: axon.v1.LedgerErrorRecord.context:type_name -> axon.v1.LedgerErrorRecord.ContextEntry
	55, // 38: axon.v1.LedgerDiagnosticRecord.payload:type_name -> axon.v1.LedgerEventPayload
	61, // 39: axon.v1.InvocationReceiptChainSummary.anchors:type_name -> axon.v1.InvocationReceiptAnchor
	66, // 40: axon.v1.InvocationTraceGraph.records:type_name -> axon.v1.InvocationLedgerRecord
	64, // 41: axon.v1.InvocationTraceGraph.edges:type_name -> axon.v1.InvocationTraceEdge
	55, // 42: axon.v1.InvocationLedgerRecord.args:type_name -> axon.v1.LedgerEventPayload
	55, // 43: axon.v1.InvocationLedgerRecord.result:type_name -> axon.v1.LedgerEventPayload
	59, // 44: axon.v1.InvocationLedgerRecord.error:type_name -> axon.v1.LedgerErrorRecord
	60, // 45: axon.v1.InvocationLedgerRecord.diagnostics:type_name -> axon.v1.LedgerDiagnosticRecord
	63, // 46: axon.v1.InvocationLedgerRecord.causal_links:type_name -> axon.v1.InvocationCausalLink
	62, // 47: axon.v1.InvocationLedgerRecord.receipt_chain:type_name -> axon.v1.InvocationReceiptChainSummary
	58, // 48: axon.v1.InvocationLedgerRecord.visibility:type_name -> axon.v1.LedgerVisibilitySummary
	9,  // 49: axon.v1.NodeDescriptor.state:type_name -> axon.v1.NodeState
	10, // 50: axon.v1.NodeDescriptor.trust_level:type_name -> axon.v1.TrustLevel
	88, // 51: axon.v1.NodeDescriptor.labels:type_name -> axon.v1.NodeDescriptor.LabelsEntry
	67, // 52: axon.v1.NodeDescriptor.resources:type_name -> axon.v1.ResourceSnapshot
	68, // 53: axon.v1.NodeDescriptor.device:type_name -> axon.v1.DeviceMeta
	85, // 54: axon.v1.NodeDescriptor.a2a_card:type_name -> axon.v1.A2AAgentCard
	11, // 55: axon.v1.NodeDescriptor.role:type_name -> axon.v1.NodeRole
	89, // 56: axon.v1.CapabilityDescriptor.requirements:type_name -> axon.v1.CapabilityDescriptor.RequirementsEntry
	84, // 57: axon.v1.CapabilityDescriptor.a2a_skill:type_name -> axon.v1.A2ASkillSpec
	83, // 58: axon.v1.CapabilityDescriptor.mcp_tools:type_name -> axon.v1.MCPToolSpec
	14, // 59: axon.v1.InvocationTarget.strategy:type_name -> axon.v1.RoutingStrategy
	10, // 60: axon.v1.InvocationTarget.min_trust_level:type_name -> axon.v1.TrustLevel
	72, // 61: axon.v1.InvocationTarget.ability:type_name -> axon.v1.AbilityTarget
	73, // 62: axon.v1.InvocationTarget.mcp_tool:type_name -> axon.v1.McpToolTarget
	74, // 63: axon.v1.InvocationTarget.a2a_skill:type_name -> axon.v1.A2aSkillTarget
	21, // 64: axon.v1.KeyInfo.state:type_name -> axon.v1.KeyState
	30, // 65: axon.v1.PayloadRef.content:type_name -> axon.v1.ContentEnvelope
	90, // 66: axon.v1.PayloadRef.labels:type_name -> axon.v1.PayloadRef.LabelsEntry
	80, // 67: axon.v1.EasyNetContext.objectives:type_name -> axon.v1.ObjectiveWeights
	22, // 68: axon.v1.EasyNetContext.enabled_hooks:type_name -> axon.v1.EasyNetHook
	23, // 69: axon.v1.MCPToolSpecSummary.category_kind:type_name -> axon.v1.MCPToolCategory
	91, // 70: axon.v1.MCPToolSpec.context_bindings:type_name -> axon.v1.MCPToolSpec.ContextBindingsEntry
	23, // 71: axon.v1.MCPToolSpec.category_kind:type_name -> axon.v1.MCPToolCategory
	84, // 72: axon.v1.A2AAgentCard.skills:type_name -> axon.v1.A2ASkillSpec
	92, // 73: axon.v1.A2AAgentCard.authentication:type_name -> axon.v1.A2AAgentCard.AuthenticationEntry
...
func file_axon_v1_types_proto_init() {
	...
	file_axon_v1_types_proto_msgTypes[51].OneofWrappers = []any{
		(*InvocationTarget_Ability)(nil),
		(*InvocationTarget_McpTool)(nil),
