...
signer-handle provenance/policy guardrails plus
...
the SDK facade. Live daemon-owned signer acquisition/keyring policy, Axon-backed receipt verification, receipt URA
