...
class CABITransportTests(unittest.TestCase):
    ...
    def test_daemon_transport_discovers_start_attaches_and_opens_runtime(
        ...
        self.assertEqual(raw.daemon_starts[0]["device_id"], "dev-a")
        self.assertEqual(raw.daemon_starts[0]["detached"], True)
        self.assertNotIn("node_id", raw.daemon_starts[0])
        self.assertNotIn("detach", raw.daemon_starts[0])
