...
def self_test(tmp: Path) -> None:
    ...
    non_canonical_cases = {
        ...
        "StaticSignatureProvider": "Process-local signer fallback",
        "NewStaticSignatureProvider": "Process-local signer fallback",
        "NewSignerFromSignature": "Process-local signer fallback",
        "Signer.from_signature": "Process-local signer fallback",
