...
def self_test(tmp: Path) -> None:
    ...
    non_canonical_cases = {
        ...
        "default_auth_for_subject": "Process-local signer helper",
        "GeneratedSubjectAuth": "Process-local signer helper",
        "generate_private_agent_auth": "Process-local signer helper",
        "generate_private_hub_auth": "Process-local signer helper",
        "GenerateSubjectAuth": "Process-local signer helper",
        "ProcessLocalSigner": "Process-local signer helper",
        "PrivateKeyAuthenticator": "Process-local signer helper",
        "StaticSignatureProvider": "Process-local signer helper",
        "NewStaticSignatureProvider": "Process-local signer helper",
        "NewSignerFromSignature": "Process-local signer helper",
        "Signer.from_signature": "Process-local signer helper",
