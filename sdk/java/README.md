...
provider, generated DTOs for every profile, provider-backed transport evidence,
or product cutover evidence. Maven package metadata exists for this seam, is
verified by `tools/scripts/check-java-sdk-seam.sh`, and declares only directly
exercised Runtime Core cases through
