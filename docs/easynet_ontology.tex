...
\midrule
Agent and System Agent (routable callees) & Device (physical substrate,
...
or Authority} identities advertising governed AbilityDescriptors. Devices exist
as execution host, sponsor, key custodian, and possible receipt attestor. A
Device may appear in bounded bootstrap, pairing, publication-custody, or
session-control caller paths enumerated by the shared
