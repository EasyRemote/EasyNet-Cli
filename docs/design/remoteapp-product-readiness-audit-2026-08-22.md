...
worker replacement can seed tracking from plugin state. This still is not full
...
media reattachment, rendered frames, endpoint cleanup, and cross-process restart
behavior.
