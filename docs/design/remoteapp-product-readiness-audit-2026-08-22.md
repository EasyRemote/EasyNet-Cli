...
or frame-drop evidence under impairment, cross-scenario proof that
...
codec. It also requires rendered media after adaptation, public RemoteApp
session abilities, selected Resource URA subject binding, and visible terminal
receipts. Its self-test proves only the contract validator; it is not codec,
