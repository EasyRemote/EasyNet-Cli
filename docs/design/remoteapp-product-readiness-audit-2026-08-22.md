...
ids, a matching `selected_route_class`, rendered media, public RemoteApp
session abilities, selected Resource URA subject binding, credential redaction,
and visible terminal receipts for every route scenario.
