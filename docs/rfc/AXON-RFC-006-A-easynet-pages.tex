...
% Status: Draft v0.2 (aligned with B v0.2: actions.* namespace
%                     mentioned; project home convention noted;
%                     shared agent skill referenced)
...
described in Appendix B for web\_apps. Most pages are simple
documents and do not need actions; agent\_view's
\texttt{actions} block is then absent or empty. This brings
pages and web\_app into a single agent-discovery convention.
