...
3. Java and Swift Mission carrier/status and Compatibility carrier/projection
   seams pass `mission/carrier_status` and
   `compatibility/openai_carrier_projection` before either package is claimed
   complete for those P1 profile coverage areas.
