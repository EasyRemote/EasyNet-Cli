...
- loading and calling the `easynet_*` C ABI v7 symbol set;
...
and `sdk/python/easynet_sdk/providers/easynet`, plus the generic C ABI v7. It
...
6. exact ABI v7 symbol/header/package checks;
