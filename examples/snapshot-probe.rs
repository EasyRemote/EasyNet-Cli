...
//
// Usage: cargo run --example snapshot-probe -- /tmp/probe.jpg
...
fn main() -> anyhow::Result<()> {
    ...
    let entry = easynet_cli::daemon::persistence::resources::ResourceEntry {
        resource_ura: "easynet:///r/probe/resource/probe-camera".to_string(),
        owner_agent: String::new(),
        kind: easynet_cli::daemon::persistence::resources::ResourceType::Camera,
        binding: easynet_cli::daemon::persistence::resources::ResourceBinding::LocalDevice,
